        ...
        <div class="moduletitle">
            <div class="moduletitleupper">Report
                <span class="pull-right">
                    <button class="form-tools" onclick="<?php echo 'document.myform.action=\''.$export_url.'\';document.myform.submit(); ' ?> " style="font-size:18px; padding-top:-10px;" title="Generate Excel">
