        ...
        <div class="col-sm-12 salesoptblock">
            ...
            <div class="row">
                <div class="col-sm-12" style="line-height: 0">
                    ...
                    <?php if ($labsource == '2') { ?>
                        <small class="pull-right" style="margin: -15px 2em 0 0;"><b>Instruction:</b> Click on the button below to indicate samples have been taken</small>
                        <div class="col-sm-4 pull-right">
                            <button type="submit" onClick="document.getElementById('viewpage').value='sampletaken';document.myform.submit;" class="btn btn-success form-control"><i class="fa fa-check"></i> Sample Taken</button>
                        </div>
                    <?php } ?>
                </div>
            </div>
