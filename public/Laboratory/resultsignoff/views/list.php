    ...
    <div class="page-wrapper">
        ...
        <div class="page form">
		    <div class="moduletitle" style="margin-bottom:0px;">
                <div class="moduletitleupper">Lab Result Sign off</div> 
            </div>
                ...
                <div class="table-title">
                    ...
                    <div class="col-sm-5">
                        <div class="input-group">
                            <input type="text" tabindex="1" value="<?php echo $fdsearch; ?>" class="form-control square-input" name="fdsearch" placeholder="Enter patient number or patient name to search..."/>
            ...
            <table class="table table-hover">
				...
				<?php $i++;	}
                        ...
                        echo "<tr><td colspan='8'>No Lab. Result Pending...</td></tr>";
                    }
					?>
                </tbody>
            </table>
