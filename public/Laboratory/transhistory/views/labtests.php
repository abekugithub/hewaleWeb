            ...
            <table class="table table-hover">
                ...
                <tbody>
                   ...
                   echo '<tr>
                            ...
                            <td>'.(($obj->LT_STATUS == '3')?'Pending':(($obj->LT_STATUS == '6' )?'Resulted':'N/A')).'</td>
												
						<td>
						'.(($obj->LT_LABRESULT =='')?'Pending':'<a href= "media/download.php?filename='. ATTACH_LABRESULT.'/'.$obj->LT_LABRESULT.'"><button type="button" class="btn btn-info btn-square" onclick="document.getElementById(\'view\').value=\'labdetails\';document.getElementById(\'viewpage\').value=\'\';">Download Results</button></a>').'
						</td>					 
