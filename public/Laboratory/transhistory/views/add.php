...
<div class="main-content">
    <div class="page-wrapper">
		...
		<input type="hidden" class="form-control" id="" name="patientcode" value="<?php echo $patientcode; ?>" readonly>
       ...
       <input type="hidden" class="form-control" id="testcode" name="testcode" value="<?php echo $testcode; ?>" readonly>
        ...
        <div class="page form">
            ...
            <div class="btn-group pull-right">
                <div class="col-sm-12">
                   ...
                   <button type="button" class="btn btn-success btn-square"  onclick="document.getElementById('viewpage').value='savespecimen';document.getElementById('view').value='labdetails';document.myform.submit();">Save</button>
