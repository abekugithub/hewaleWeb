    ...
    <div class="page-wrapper">
        ...
        <div class="page form">
            <div class="moduletitle" style="margin-bottom:0px;">
                ...
                <div class="moduletitleupper">Pending Lab Request</div> 
            </div>
            ...
            <div class="pagination-tab">
                ...
                <div class="table-title">
                    ...
                    <div class="pagination-right" id="hiddenbtn" >
                                 </div>
                </div>
            </div>
            ...
            <table class="table table-hover">
                ...
                ?>                           
                    <tr>
                       <td><?= $num ?></td>
					   <td><?= $sql->UserDate($obj->LTM_DATE,'d/m/Y') ?></td>
                       <td><?= $obj->LTM_PACKAGECODE ?></td>
                       <td><?= $obj->LTM_PATIENTNAME ?></td>
                       <td><?= $obj->LTM_PATIENTNUM ?></td>
                       <td><?= $obj->LTM_TOTAL_AMOUNT ?></td>
                       <td><?= $obj->LTM_ACTORNAME ?></td>
                       <td><?= $rphone ?></td>
                       <td><?= $obj->LTM_HOMESERVICE ?></td>
                       <td><?= $statusdesc[$obj->LTM_STATUS] ?></td>                    
					   <td>
                           <?php if ($obj->LTM_STATUS > 2) { ?>
                                <!-- <button type="submit" class="btn btn-info btn-square" onclick="document.getElementById('view').value='labdetails';document.getElementById('keys').value='<?= $obj->LTM_PACKAGECODE ?>';document.getElementById('viewpage').value='testdetails';document.myform.submit;">Details </button> -->
                        
                                <button type="submit" class="btn btn-info btn-square" onclick="document.getElementById('view').value='labsample';document.getElementById('keys').value='<?= $obj->LTM_PACKAGECODE ?>';document.getElementById('viewpage').value='testdetails';document.myform.submit;">Sample Details </button>    
                           <?php } else {
                            ?>
                                <button type="submit" class="btn btn-info btn-square" onclick="document.getElementById('view').value='labdetails';document.getElementById('keys').value='<?= $obj->LTM_PACKAGECODE ?>';document.getElementById('viewpage').value='testdetails';document.myform.submit;">Details </button>
                            <?php
