...
.rowinfo{
 ...
 <div class="page-wrapper">
     ...
     <div class="moduletitle" style="margin-bottom:0px;">
            ...
            <button class="btn btn-dark pull-right" onclick="document.getElementById('view').value='';document.myform.submit;" style="font-size:15px; padding-top:-10px; line-height:1.3em;  margin-top:-50px;" title="Back" formnovalidate><i class="fa fa-arrow-left"></i> Back</button>
        ...
        <div class="col-sm-12 salesoptblock">
            ...
            <div class="row">
                <div class="col-sm-12" style="line-height: 0">
                    ...
                    <small class="pull-right" style="margin: -15px 2em 0 0;"><b>Instruction:</b> Click on the Done button below to after all specimen samples have been taken</small>
                    <div class="col-sm-4 pull-right">
                        <button type="submit" onClick="document.getElementById('viewpage').value='updateprice';document.myform.submit;" class="btn btn-success form-control"><i class="fa fa-check"></i> Done</button>
                    </div>
                </div>
            </div>
                    ...
                    if($stmtlisttestdetails->Recordcount() > 0 ){
					    while ($obj = $stmtlisttestdetails->FetchNextObject()){
                            echo '<tr>
                                    ...
                                    <td>'.(($obj->LT_SPECIMENSTATE == '0')?'Pending':(($obj->LT_SPECIMENSTATE == '1' )?'Sample Taken':'N/A')).'</td>
                                    <td>
