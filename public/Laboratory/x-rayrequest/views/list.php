            ...
            <table class="table table-hover">
                ...
                if($paging->total_rows > 0 ){
                    ...
                    while(!$rs->EOF){
						...
						<button type="submit" class="btn btn-info btn-square" onclick="document.getElementById(\'view\').value=\'labdetails\';document.getElementById(\'keys\').value=\''.$obj->XT_VISITCODE.'\';document.getElementById(\'viewpage\').value=\'testdetails\';document.myform.submit;">Details</button>
