...
$stmt = $sql->Execute($sql->Prepare("SELECT * FROM hms_patient_labtest WHERE LT_LABCODE = ".$sql->Param('a')." AND LT_STATUS = '0' AND LT_DATE BETWEEN ".$sql->Param('b')." AND ".$sql->Param('c')),array($activeinstitution,$from,$to));
print $sql->ErrorMsg();
        //$result = array();
        $num = 1;
