        ...
        <div class="page form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <select id="residence" name="residence" class="form-control" readonly>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" value="<?php echo $specialisation; ?>" id="specialisation" name="specialisation" disabled>
                </div>
