...
.rowinfo{
 ...
 <div class="page-wrapper">
     ...
     <div class="moduletitle" style="margin-bottom:0px;">
            <div class="moduletitleupper">Ultrasound Results Details</div>
        ...
        <div class="col-sm-12 salesoptblock">
            ...
            <table class="table table-hover">
                ...
                <tbody>
                   ...
                   <td>
                   <div align="center" >
                       '.(($obj->XT_STATUS =='6' )?'<input type="checkbox" value="'.$obj->XT_CODE.'" name="syscheckbox['.$obj->XT_CODE.']" id="selcheck"   > '
                       :($obj->XT_STATUS == '7'?'Approved':'Cancelled')).'
                       </div>    
                   </td>  
						    <td>'.$num.'</td>
                            ...
                            <td>'.(($obj->XT_STATUS == '3')?'Pending':(($obj->XT_STATUS == '6' )?'Results Attached':'N/A')).'</td>
												
						<td>						
                           
                        '.(($obj->XT_STATUS == '6')?'<button type="submit" class="btn btn-info btn-square" onclick="document.getElementById(\'view\').value=\'results\';document.getElementById(\'vkey\').value=\''.$obj->XT_CODE.'\';document.getElementById(\'viewpage\').value=\'result\';document.myform.submit;">View Results</button>':(($obj->XT_STATUS == '8')?'<button type="submit" class="btn btn-warning btn-square" onclick="document.getElementById(\'view\').value=\'results\';document.getElementById(\'vkey\').value=\''.$obj->XT_CODE.'\';document.getElementById(\'viewpage\').value=\'res\';document.myform.submit;">Change Results</button>':'N/A')).'
