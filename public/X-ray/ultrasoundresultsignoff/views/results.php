...
.rowinfo{
 ...
 <div class="page-wrapper">
     ...
     <div class="moduletitle" style="margin-bottom:0px;">
            ...
            <button class="btn btn-dark pull-right" onclick="document.getElementById('view').value='details';document.myform.submit;" style="font-size:15px; padding-top:-10px; line-height:1.3em;  margin-top:-40px;" title="Back" formnovalidate>Back</button>
