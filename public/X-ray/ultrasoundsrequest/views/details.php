...
.rowinfo{
 ...
 <div class="page-wrapper">
     ...
     <div class="moduletitle" style="margin-bottom:0px;">
            <div class="moduletitleupper">Ultrasound Request Details</div>
