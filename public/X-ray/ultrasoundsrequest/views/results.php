...
.rowinfo{
 ...
 <div class="page-wrapper">
     ...
     <div class="moduletitle" style="margin-bottom:0px;">
            <div class="moduletitleupper">Ultrasound Results</div>
        ...
        <div class="col-sm-12 salesoptblock">
                <div class="col-sm-8 salesoptselect">
                    <div class="form row">
                        ...
                        <div class="col-sm-6 form-group">
                        <label class="form-label required">Ultrasound:  <?php echo ($testname?$testname:'N/A') ;?> </label>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4 required">
                    <label for="othername">Attach (JPEG ONLY)</label>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                   ...
                   echo '<tr>
						    ...
						    <td>'.$num.'</td>
                            <td>'.$obj->XTMI_LTCODE.'</td>
                            					
						<td>
						'.(($obj->XTMI_FILENAME =='')?'Pending':'<a href= "media/download.php?filename='. ATTACH_SCANRESULT.'/'.$obj->XTMI_FILENAME.'"><button type="button" class="btn btn-info btn-square" onclick="document.getElementById(\'view\').value=\'labdetails\';document.getElementById(\'viewpage\').value=\'\';">Download Results</button></a>').'
                        </td>	
                        
                        <td> 
						
						 <button type="submit" class="btn btn-info btn-square" onclick="document.getElementById(\'view\').value=\'\';document.getElementById(\'cde\').value=\''.$obj->XTMI_ID.'\';document.getElementById(\'viewpage\').value=\'removeresults\';document.myform.submit;">Remove </button>
