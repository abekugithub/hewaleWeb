...
.rowinfo{
 ...
 <div class="page-wrapper">
     ...
     <div class="moduletitle" style="margin-bottom:0px;">
            <div class="moduletitleupper">Ultrasound Request</div>
        ...
        <div class="col-sm-12 salesoptblock">
                <div class="col-sm-8 salesoptselect">
                    <div class="form row">
                        ...
                        <div class="col-sm-6 form-group">
                            <label class="form-label required">Gender: <?php echo ($patientgender?$patientgender:'N/A');?></label>
            ...
            <table class="table table-hover" style="margin-top: 21em">
                ...
                if($stmtlist->Recordcount() > 0 ) {
                    while ($obj = $stmtlist->FetchNextObject()) {
						...
						<td>					
							<button type="submit" class="btn btn-info btn-square" onclick="document.getElementById(\'view\').value=\'results\';document.getElementById(\'target\').value=\'' . $obj->XT_CODE . '\';document.getElementById(\'viewpage\').value=\'res\';document.myform.submit();">Attach Results</button>
						</td>					 				
					</tr>';
                        $num++;
                    }
