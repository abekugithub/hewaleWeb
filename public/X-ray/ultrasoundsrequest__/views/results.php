...
.rowinfo{
 ...
 <div class="page-wrapper">
     ...
     <input type="text" class="form-control" id="discpline" name="target" value="<?php echo $target; ?>" readonly>
     ...
     <div class="moduletitle" style="margin-bottom:0px;">
            ...
            <button class="btn btn-dark pull-right" onclick="document.getElementById('view').value='requestdetails';document.myform.submit;" style="font-size:15px; padding-top:-10px; line-height:1.3em;  margin-top:-40px;" title="Back" formnovalidate>Back</button>
        ...
        <div class="col-sm-12 salesoptblock">
                <div class="col-sm-8 salesoptselect">
                    <div class="form row">
                        ...
                        <label class="form-label required">Package Code: <?php echo ($packagecode?$packagecode:'');?></label>
                        ...
                        <div class="col-sm-6 form-group">
                        <label class="form-label required">Request:  <?php echo ($test?$test:'N/A') ;?> </label>
                           
                        </div>
                        <div class="col-sm-6 form-group">
                        <label class="form-label required">Remarks:  <?php echo ($remarks?$remarks:'N/A') ;?> </label>
