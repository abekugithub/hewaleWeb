            ...
            <table class="table table-hover">
                ...
                if($paging->total_rows > 0 ){
                    ...
                    while(!$rs->EOF){
						...
						<button type="submit" class="btn btn-info btn-square" onclick="document.getElementById(\'view\').value=\'requestdetails\';document.getElementById(\'keys\').value=\''.$obj->XTM_VISITCODE.'\';document.getElementById(\'viewpage\').value=\'requestdetails\';document.myform.submit;">Details</button>
