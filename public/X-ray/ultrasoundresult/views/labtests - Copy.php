            ...
            <table class="table table-hover">
                ...
                <tbody>
                   ...
                   echo '<tr>
                            ...
                            <td>'.$obj->LTMI_FILENAME.'</td>
                            <td>
						                           
                            '.(($obj->LT_STATUS == '6')?'<a href= "media/download.php?filename='. ATTACH_LABRESULT.'/'.$obj->LTMI_FILENAME.'"><button type="button" class="btn btn-info btn-square" onclick="document.getElementById(\'view\').value=\'labdetails\';document.getElementById(\'viewpage\').value=\'\';">Download Results</button></a>':(($obj->LT_STATUS == '70')?'Not Completed':'N/A')).'
