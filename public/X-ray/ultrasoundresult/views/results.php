            ...
            <table class="table table-hover">
                ...
                <tbody>
					...
					while ($obj = $stmtlisttestresults->FetchNextObject()){
                        ...
                        $printpath="public/dcomviewer/viewer.php?visitcode=".$obj->XTMI_VISITCODE.'&keys='.$requestcode;
                   ...
                   echo '<tr>
						...
						<td>
						'.(($obj->XTMI_FILENAME =='')?'Pending':'<iframe width="900px" height="400px" src="'.$printpath.'"></iframe>').'
						</td>					 
