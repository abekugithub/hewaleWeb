    ...
    <div class="page-wrapper">
        <div class="page form">
            <div class="moduletitle" style="margin-bottom:0px;">
                <div class="moduletitleupper">Pending X-ray Request</div>
            </div>
            ...
            <table class="table table-hover">
                ...
                if($paging->total_rows > 0 ){
                    ...
                    while(!$rs->EOF){
						...
						<td>'.$obj->XT_ACTORNAME.'</td>
						<td> 
						
						<button type="submit" class="btn btn-info btn-square" onclick="document.getElementById(\'view\').value=\'xraydetails\';document.getElementById(\'keys\').value=\''.$obj->XT_VISITCODE.'\';document.getElementById(\'viewpage\').value=\'testdetails\';document.myform.submit;">Details</button>
