        ...
        <div class="page-wrapper">
            ...
            <div class="page form">
                <div class="moduletitle" style="margin-bottom:0px;">
                    <div class="moduletitleupper">Manage Assets</div>
                </div>
                    ...
                    <div class="table-title">
                        ...
                        <div class="pagination-right">
                             ...
                             <button type="submit"  onclick="document.getElementById('view').value = 'add'; document.myform.submit();"  class="btn btn-success">
                                    <i class="fa fa-plus-circle"></i> Create Asset</button>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-hover">
                 ...
                 $num = 1;
                  if($paging->total_rows > 0 ){
						   ...
						   $delievery = $obj->MA_STATUS;
						   $delstatus = "";
						   
						   if ($delievery == '1') {
							   $delstatus = 'Functioning';
							   }elseif ($delievery == '0') {
								$delstatus = 'Not functioning';
							   }elseif($delievery == '2'){
								$delstatus = 'Faulty';
								}else {
									
								$delstatus = 'At Repairing Center';	
								}
                    
                   echo '<tr>
                        <td>'.$num++.'</td>
                        <td>'.$obj->MA_NAME.'</td>
                        <td>'.$obj->MA_ASSETNO.'</td>
						...
						<div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><button type="submit" onclick="document.getElementById(\'view\').value=\'edit\';document.getElementById(\'keys\').value=\''.$obj->MA_CODE.'\';document.getElementById(\'viewpage\').value=\'edit\';document.myform.submit;">View Details</button></li>
