        ...
        <div class="page-wrapper">
            ...
            <div class="page form">
                <div class="moduletitle" style="margin-bottom:0px;">
                    <div class="moduletitleupper">Package (Pending Delivery)</div>
                </div>
                ...
                <table class="table table-hover">
                 ...
                 $num = 1;
                  if($paging->total_rows > 0 ){
						...
						<button class="btn btn-primary" type="button" onClick="document.getElementById(\'view\').value=\'edit\';document.getElementById(\'viewpage\').value=\'edit\';document.getElementById(\'keys\').value=\''.$obj->COB_PRESCRIPTIONCODE.'\';document.myform.submit()"><span class="fa fa-pencil"></span> Details</button>
