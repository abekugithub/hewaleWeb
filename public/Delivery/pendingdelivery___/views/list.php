        ...
        <div class="page-wrapper">
            ...
            <div class="page form">
                <div class="moduletitle" style="margin-bottom:0px;">
                    <div class="moduletitleupper">Pending Delivery</div>
                </div>
                ...
                <div class="pagination-tab">
                    <div class="table-title">
                        ...
                        <div class="pagination-right">
                           <!--<button type="submit"  onclick="document.getElementById('viewpage').value = 'selectpresc'; document.myform.submit();"  class="btn btn-success">
                                    <i class="fa fa-plus-circle"></i> Load Prescription</button>-->
                        </div>
                    </div>
                </div>
                 ...
                 $num = 1;
                  if($paging->total_rows > 0 ){
                   ...
                   echo '<tr>
                        ...
                        <td>'.$obj->PRESC_PHARMNAME.'</td>
                        <td>'.$obj->PRESC_PHARMLOC.'</td>
                        <td>'.$obj->PRESC_DATE.'</td>
						<td>'.$delstatus.'</td>
						<td>
						<div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><button type="submit" onclick="document.getElementById(\'view\').value=\'edit\';document.getElementById(\'keys\').value=\''.$obj->PRESC_PICKUPCODE.'\';document.getElementById(\'viewpage\').value=\'edit\';document.myform.submit();">View Package</button></li>
