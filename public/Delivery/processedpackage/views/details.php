...
?>
  ...
  <div class="main-content">
    ...
    <input type="hidden"  name="agentname" class="form-control" value="<?php echo  $agentname ;?>"  >
    ...
    <?php $engine->msgBox($msg,$status); ?>
      ...
      <div class="page form">
        <div class="moduletitle" style="margin-bottom:0px;">
          ...
          <div class="moduletitleupper">View Delivery for:
            <?php echo $patient;?>  
        ...
        <div class="pagination-tab">
          <div class="table-title">
            <div class="pagination-left">
                ...
                <div class="col-sm-4">
                    <label class="control-label" for="leavetype">Reassign:</label>
    ...
    <?php }elseif($delstatus == '3') {?>
      
      
            <ol class="progtrckr" data-progtrckr-steps="5">
      <li class="progtrckr-done"> Pending</li>
      <li class="progtrckr-done"> Assigned</li><!--
    --><li class="progtrckr-done">Pharmacy Pickup</li><!--
	 --><li class="progtrckr-todo">In Transit</li><!--
     --><li class="progtrckr-todo">Delivered</li>
    </ol>
    
	 <?php }elseif($delstatus == '4') {?>
