<div class="page-wrapper">
        <div class="page form">
            <div class="moduletitle">
                <div class="moduletitleupper">Edit Agent Form <span class="pull-right">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" id="date" name="startdate" value="<?php echo $agentdob;?>">
                </div>
            </div>

            <div class="btn-group pull-right">
                <div class="col-sm-12">
                    <button type="submit" class="btn btn-success" onClick="document.getElementById('viewpage').value='updateagent';document.linkform.submit();"><i class="fa fa-save"></i> Submit</button>
