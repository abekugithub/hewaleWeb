        ...
        <div class="page-wrapper">
            ...
            <div class="page form">
                <div class="moduletitle" style="margin-bottom:0px;">
                    <div class="moduletitleupper">Delivery History</div>
                </div>
                    ...
                    <div class="table-title">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                <input type="text" tabindex="1" value="<?php echo $fdsearch; ?>" class="form-control square-input" name="fdsearch" placeholder="Enter History to Search"
                                />
                   ...
                   echo '<tr>
						...
						<div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><button type="submit" onclick="document.getElementById(\'view\').value=\'edit\';document.getElementById(\'keys\').value=\''.$obj->PRESC_PICKUPCODE.'\';document.getElementById(\'viewpage\').value=\'edit\';document.myform.submit;">View Prescription</button></li>
