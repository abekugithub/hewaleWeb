...
<br />
            <div class="btn-group pull-right">
                <div class="col-sm-12">
                    <button type="button" class="btn btn-success" id="addstock"><i class="fa fa-plus"></i> Add Stock</button>
...
<table class="table table-hover">
		  ...
		  if($stmtsup){
           ...
           <td class="hidden-xs">
           <button type="button" class="btn btn-gyn-danger square recallrow btn-danger" title="Delete">
	     ...
	     ';
					...
					?>
                    <tr><td colspan="8">
                     <div align="center">No stock not added yet</div>
                     </td></tr>
                </tbody>
            </table>
