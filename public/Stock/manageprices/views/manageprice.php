                           ...
                           <div class="col-sm-6">
                                <label for="item">item name:</label>
                                 <select name="item" id="item" class="form-control">
  								...
  								<option value="<?php echo $objitem->ST_CODE?>" data-dosage="<?php echo $objitem->ST_DOSAGENAME;?>"  <?php echo (($item == $objitem->ST_CODE)?'Selected':'') ?>><?php echo $objitem->ST_NAME ;?></option>
   								<?php } ?>  
