<div class="page-wrapper">
        <div class="page form">
            <div class="moduletitle">
                <div class="moduletitleupper">Edit Supplier Form <span class="pull-right">
            ...
            <div class="btn-group pull-right">
                <div class="col-sm-12">
                    <button type="submit" class="btn btn-success" onClick="document.getElementById('viewpage').value='updatesupplier';document.linkform.submit();"><i class="fa fa-save"></i> Submit</button>
