        ...
        <div class="page-wrapper">
            ...
            <div class="page form">
                <div class="moduletitle" style="margin-bottom:0px;">
                    <div class="moduletitleupper">Stocks Level</div> 
                </div>
<?php $engine->msgBox($msg,$status); ?>
                 ...
                 $num = 1;
                  if($paging->total_rows > 0 ){
                   ...
                   echo '<tr >
                        ...
                        <td>'.$obj->ST_NAME.'</td>
                        <td>'.$obj->ST_DOSAGE.'</td>
						<td>'.$obj->ST_STORE_QTY.'</td>
						<td>'.$obj->ST_SHEL_QTY.'</td>
						<td>'.number_format($obj->ST_SHEL_QTY +$obj->ST_STORE_QTY,0) .'</td>
						<td><div class="">
						<button type="submit" class="btn btn-info btn-square" onclick="document.getElementById(\'keys\').value=\''.$obj->ST_CODE.'\';document.getElementById(\'viewpage\').value=\'edititem\';document.getElementById(\'view\').value=\'edit\';document.myform.submit;">Move</button>
						</div>
                        </td>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Move Stock</h4>
      </div>
      <div class="modal-body">
        <p>Move stock from store to shelf.</p>
