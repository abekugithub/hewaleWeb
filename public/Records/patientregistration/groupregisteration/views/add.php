...
<div class="main-content">
    <form action="" method="post" enctype="multipart/form-data" name="myform">
	    ...
	    <input type="" class="form-control" id="groupcode" name="groupcode" value="<?php echo $groupcode; ?>" >
    ...
    <div class="page-wrapper">
        <div class=" col-sm-4 pull-right">
            <div class="pull-right ">
                ...
                <button type="submit" onclick="document.getElementById('v').value='group';document.getElementById('viewpage').value='save';document.myform.submit;" class="btn btn-success"><i class="fa fa-check"></i> Save </button>
            </div>
