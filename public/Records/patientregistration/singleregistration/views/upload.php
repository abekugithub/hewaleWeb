            ...
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-6" style="margin-top: 25px">
                        <button type="button" class="btn btn-success" onclick="document.getElementById('views').value='';document.getElementById('viewpages').value='uploadfile';document.myform.submit();"><i class="fa fa-check"></i> Save</button>
                    </div>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-12 img-responsive">
                        <img src="media/img/patientregistrationsample.png" style="width: 100%;" />
                    </div>
                </div>
