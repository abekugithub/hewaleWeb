...
<div class="main-content form">
    <form action="" method="post" enctype="multipart/form-data" name="myform">
	    ...
	    <input type="hidden" class="form-control" id="patphoto" name="patphoto" value="<?php echo $patientphoto; ?>" >
    <div class="page-wrapper">
        <div class=" col-sm-4 pull-right">
                    <div class="pull-right btn-group">
                        ...
                        <button type="submit" onclick="document.getElementById('views').value='';document.getElementById('viewpages').value='save';document.myform.submit;" class="btn btn-success"><i class="fa fa-check"></i> Save </button>
                    </div>
        </div>
        ...
        <?php if (empty($patientcode)){?>
            <li><a data-toggle="tab" id="hiddentab" href="#requestservice">6. Request Service</a></li>
            <?php } ?>
    </ul>

        <div class="page ">
                <div class="tab-content">
                    <!--      1. Start of Personal Tab          -->
                    <div id="personal" class="tab-pane fade in active">
                        <h3>Personal Information</h3>
                        <div class="col-sm-2">
                            <div class="id-photo">
                                <img src="<?php echo((!empty($patientphoto))?'media/uploaded/patientphotos/'.$patientphoto:'media/img/avatar.png');?>" alt="" id="prevphoto" style="width:100% !important; margin:0px !important;">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <label for="mstatus" class="required">Marital Status:</label>
                                ...
                                <div class="col-sm-4">
                                    <label for="residence" class="required">Country of Residence:</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="tel" class="form-control" id="phonenumber" name="phonenumber" value="<?php echo $phonenumber; ?>" placeholder="0244449999">
                                </div>
                                <div class="col-sm-4">
                                    <label for="altphonenumber">Alternative Phone Number:</label>
                                    <input type="tel" class="form-control" id="altphonenumber" name="altphonenumber" value="<?php echo $altphonenumber; ?>" placeholder="0244449999">
                                </div>

                                <div class="col-sm-4">
                                    <label for="email">Email:</label>
                                    <input type="email" class="form-control" id="email" name="email" value="<?php echo $email; ?>" placeholder="johndoe@email.com">
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control" id="emername1" name="emername1" value="<?php echo $emergname1; ?>">
                                </div>
                                <div class="col-sm-4">
                                    <label for="emerphonenumber1">Emergency Contact Number 1:</label>
                                    <input type="tel" class="form-control" id="emerphonenumber1" name="emerphonenumber1" value="<?php echo $emergnum1; ?>">
                                </div>
                                <div class="col-sm-4">
                                    <label for="emeraddress1">Emergency Contact Address 1:</label>
                                    <input type="text" class="form-control" id="emeraddress1" name="emeraddress1" value="<?php echo $emergadd1; ?>">
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control" id="emername2" name="emername2" value="<?php echo $emername2; ?>">
                                </div>
                                <div class="col-sm-4">
                                    <label for="emerphonenumber2">Emergency Contact Number 2:</label>
                                    <input type="tel" class="form-control" id="emerphonenumber2" name="emerphonenumber2" value="<?php echo $emernum2; ?>">
                                </div>
                                <div class="col-sm-4">
                                    <label for="emeraddress2">Emergency Contact Address 2:</label>
                                    <input type="text" class="form-control" id="emeraddress2" name="emeraddress2" value="<?php echo $emeradd2; ?>">
                                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control" id="bgroup" name="bgroup" value="<?php echo $bloodgrp; ?>">
                                </div>
                                <div class="col-sm-4">
                                    <label for="allergies">Allergies:</label>
                                    <input type="text" class="form-control" id="allergies" name="allergies" value="<?php echo $allergy; ?>">
                                </div>
                                <div class="col-sm-4">
                                    <label for="conditions">Chronic Conditions:</label>
                                    <input type="text" class="form-control" id="conditions" name="conditions" value="<?php echo $chronic;?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <select id="relation" name="relation" class="form-control" >
                                        ...
                                        <option value="Spouse" <?php echo (($relation == 'Parent')?"selected":"");?>>Parent</option>
                            ...
                            <div class="form-group">
                                <div class="col-sm-10">
                                    <table id="datatable" class="table table-bordered">
                                        ...
                                        <?php
                                        $i=1;
                                        if(!empty($relationstmt)){
                                            while($relation = $relationstmt->FetchNextObject()){
                                                echo '
                                    <tr>
                                       <td>'.$i++.'  </td>
                    ...
                    <!--       6. Start of Request Service Tab         -->
                            ...
                            <div class="form-group">
                                <div class="col-sm-4">
                                    ...
                                    <select name="paymentscheme" id="paymentscheme" class="form-control select2">
                                        <option value="" selected disabled>-- Select Payment Scheme --</option>
<!--                                        --><?php //while ($payscheme = $stmtscheme->FetchNextObject()){?>
<!--                                            <option value="--><?php //echo $payscheme->PINS_METHOD_CODE.'@@@'.$payscheme->PINS_METHOD?><!--">--><?php //echo $payscheme->PINS_METHOD?><!--</option>-->
<!--                                        --><?php //} ?>
                                    </select>
                                </div>
...
<!--                                    <input type="text" class="form-control datepicker" id="cardexpirydate" name="cardexpirydate" >-->
<!--                                </div>-->
