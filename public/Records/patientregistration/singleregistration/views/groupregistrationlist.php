        ...
        <div class="page form">
            ...
            <div class="pagination-tab">
                <div class="table-title">
                    ...
                    <div class="col-sm-2">
                        <button type="button" onclick="document.getElementById('action_search').value='';document.getElementById('views').value='groupregistrationlist';document.getElementById('viewpages').value='reset';document.myform.submit();" class="btn btn-success btn-square">
...
<!--                    <th>Marital Status</th>-->
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo (($obj->PATGRP_GROUPTYPE=='1')?'Family':'Company'); ?></td>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <button type="button" class="btn" title="Add Patient to this Group" onclick="document.getElementById('views').value='groupregistrationadd';document.getElementById('groupcode').value='<?php echo $obj->PATGRP_CODE;?>';document.getElementById('groupname').value='<?php echo $obj->PATGRP_NAME;?>';document.myform.submit();"><i class="fa fa-plus-circle"></i> Add Member</button>
                                    </li>
                                    <li>
                                        <button type="button" class="btn" title="Edit this Group" data-toggle="modal" data-target="#Group" onclick="document.getElementById('groupcode').value='<?php echo $obj->PATGRP_CODE;?>';document.getElementById('groupname').value='<?php echo $obj->PATGRP_NAME;?>';document.getElementById('grouptype').value='<?php echo $obj->PATGRP_GROUPTYPE;?>';document.getElementById('groupcode').value='<?php echo $obj->PATGRP_CODE;?>';"><i class="fa fa-pencil"></i> Edit Group</button>
                                    </li>
                                </ul>
                            </div>

                            <button type="button" class="btn btn-success" title="View Patients in this Group" onclick="document.getElementById('groupcode').value='<?php echo $obj->PATGRP_CODE?>';document.getElementById('groupname').value='<?php echo $obj->PATGRP_NAME?>';document.getElementById('views').value='viewgroup';document.myform.submit();"><i class="fa fa-eye"></i> View Members</button>
                        </td>
                    </tr>
                <?php $num++; }
                }
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        ...
                        <select name="grouptype" id="grouptype" class="form-control" <?php echo (($grouptype==$grouptype)?'selected':'');?>>
...
<!--                        <input class="form-control" id="groupname" name="groupname" placeholder="Enter Group Name" type="text" required/>-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <button type="button" id="newgroup" class="btn btn-success btn-square" data-dismiss="modal" onclick="document.getElementById('views').value='groupregistrationadd';/*document.myform.submit();/*document.getElementById('viewpages').value='add';*/"><i class="fa fa-check"></i> Save</button>
