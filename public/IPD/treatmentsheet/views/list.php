        ...
        <div class="page-wrapper">
            ...
            <div class="page form">
                <div class="moduletitle" style="margin-bottom:0px;">
                    <div class="moduletitleupper">Patients Treatment Sheet</div> 
                </div>
            <?php $engine->msgBox($msg,$status); ?>
                 ...
                 $num = 1;
                  if($paging->total_rows > 0 ){
                   ...
                   echo '<tr >
                        ...
                        <td> 						
						<button type="submit" class="btn btn-info btn-square" onclick="document.getElementById(\'view\').value=\'treatment\';document.getElementById(\'keys\').value=\''.$obj->ADMIN_PATIENTNO.'@@'.$obj->ADMIN_VISITCODE.'@@'.$obj->ADMIN_WARDID.'@@'.$obj->ADMIN_WARD.'@@'.$obj->ADMIN_BEDID.'@@'.$obj->ADMIN_BED.'\';document.getElementById(\'viewpage\').value=\'treatment\';document.myform.submit;">Details</button>
