...
?>
    ...
    <div class="main-content notepaper">
        ...
        <div class="page-wrapper">
          ...
          <button type="button"  class="btn btn-dark" onclick="document.getElementById('view').value='admdetails';document.getElementById('viewpage').value='admdetails';document.myform.submit()" ><i class="fa fa-arrow-left"></i> Back </button>
          </span>
                    </div>
                </div>
                <?php $engine->msgBox($msg,$status); ?>
...
"document.getElementById(\'viewpage\').value=\'historydetails\';document.getElementById(\'view\').value=\'historydetails\';document.getElementById(\'keys\').value=\''.$obj->CONS_PATIENTNUM.'@@'.$obj->CONS_VISITCODE.'\';document.myform.submit()"> Details</button>
