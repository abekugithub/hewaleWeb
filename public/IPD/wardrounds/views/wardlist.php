  ...
  <div class="page-wrapper">
    <div class="page form">
      <div class="moduletitle" style="padding-bottom:0 !important">
        <div class="moduletitleupper" style="font-size:17px; font-weight:500;">Patient Ward Round for <?php  $dataobj=$patientCls->getPatientDetails($patientno[0]);echo $dataobj->PATIENT_FNAME." ".$dataobj->PATIENT_MNAME." ".$dataobj->PATIENT_LNAME; ?> [ <?php echo  $patientno[0] ;?>]<span class="pull-right">
				...
				<?php } ?> 
                    ...
                    <div id="diagnosis" class="tab-pane fade">
                      ...
                      <div class="control-group span4">
                        ...
                        <div class="controls">
                          <textarea name='remark' id="remark"></textarea><div class="form-group">
                    <div class="col-sm-12 client-vitals">
                     <table class="table table-hover">
                            <thead>
