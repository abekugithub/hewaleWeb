        ...
        <div class="page-wrapper">
            ...
            <div class="page form">
                <div class="moduletitle" style="margin-bottom:0px;">
                    <div class="moduletitleupper">My Staff</div>
                </div>
                    ...
                    <div class="table-title">
                        ...
                        <div class="pagination-right">
                             ...
                             <button type="submit"  onclick="document.getElementById('view').value = 'add'; document.myform.submit();"  class="btn btn-success">
                                    <i class="fa fa-plus-circle"></i> Create Staff</button>
                        </div>
                    </div>
                </div>
                ...
                <table class="table table-hover">
                 ...
                 $num = 1;
                  if($paging->total_rows > 0 ){
                   ...
                   echo '<tr>
                        <td>'.$num++.'</td>
                        <td>'.$obj->SM_FNAME." ".$obj->SM_SURNAME.'</td>
                        <td>'.$obj->SM_PHONE.'</td>
                        <td>'.$obj->SM_EMAIL.'</td>
						<td>'.$delstatus.'</td>
						<td><button class="btn btn-info btn-square" type="button" onClick="document.getElementById(\'view\').value=\'edit\';document.getElementById(\'viewpage\').value=\'edit\';document.getElementById(\'keys\').value=\''.$obj->SM_CODE.'\';document.myform.submit()"><span class="fa fa-pencil"></span> Edit</button> 
