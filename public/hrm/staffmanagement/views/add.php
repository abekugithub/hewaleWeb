        ...
        <div class="page form">
            ...
            <div class="col-sm-2">
                ...
                <div class="col-sm-4 required">
                    ...
                    <input type="text" class="form-control" id="fname" name="fname" value="<?php echo $fnames;?>">
                </div>
                <div class="col-sm-4 required">
                ...
                <div class="col-sm-4">
                    <label for="email">Salary Grade</label>
                     ...
                     <select name="grade" id="grade" value="" class="form-control">
                                        ...
                                        <option value='<?php echo $obj->PG_CODE; ?>' <?php  echo (($obj->PG_CODE == $objany)?"selected":""); ?>><?php echo $obj->PG_NAME; ?></option>
                                        <?php } ?>
                    </select>
            ...
            <div class="btn-group pull-right">
                <div class="col-sm-12">
                    <button type="submit" class="btn btn-success" onClick="document.getElementById('viewpage').value='insertstaff';document.myform.submit();"><i class="fa fa-save"></i> Submit</button>
