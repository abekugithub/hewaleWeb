                    ...
                    <div class="table-title">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                <input type="text" tabindex="1" value="<?php echo $fdsearch; ?>" class="form-control square-input" name="fdsearch" placeholder="Enter Salary Component to Search"
                                />
                        ...
                        <div class="pagination-right">
                             ...
                             <button type="submit"  onclick="document.getElementById('view').value = 'add'; document.myform.submit();"  class="btn btn-success">
                                    <i class="fa fa-plus-circle"></i> Add Component</button>
                        </div>
                    </div>
                </div>
                 ...
                 $num = 1;
                  if($paging->total_rows > 0 ){
                   ...
                   echo '<tr>
						...
						<td>'.$saltypestatus.'</td>
						<td>'.$delstatus.'</td>
						<td><button class="btn btn-primary" type="button" onClick="document.getElementById(\'view\').value=\'edit\';document.getElementById(\'viewpage\').value=\'edit\';document.getElementById(\'keys\').value=\''.$obj->SC_CODE.'\';document.myform.submit()"><span class="fa fa-pencil"></span> Edit</button> 
