                 ...
                 $num = 1;
                  if($paging->total_rows > 0 ){
                   ...
                   echo '<tr>
                        ...
                        <td>'.$agentdob.'</td>
						<td>'.$delstatus.'</td>
						<td><button class="btn btn-info btn-square" type="button" onClick="document.getElementById(\'view\').value=\'edit\';document.getElementById(\'viewpage\').value=\'edit\';document.getElementById(\'keys\').value=\''.$obj->LR_CODE.'\';document.myform.submit()"><span class="fa fa-desktop"></span> View Request</button> 
