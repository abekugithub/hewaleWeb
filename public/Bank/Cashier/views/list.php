    ...
    <div class="page-wrapper">
        <div class="page form">
            <div class="moduletitle" style="margin-bottom:0px;">
                <div class="moduletitleupper">Cash Transactions </div>
            </div>

            
            <form action="" method="post" enctype="multipart/form-data" name="myform">
                <input type="hidden" name="views" value="" id="views" class="form-control" />
                <input type="hidden" name="viewpage1" value="" id="viewpage1" class="form-control" />
                <input type="hidden" name="keys1" value="" id="keys1" class="form-control" />
                ...
                <table class="table table-hover">
                    ...
                    if($paging->total_rows > 0 ){
                        ...
                        while(!$rs->EOF) {
                            ...
                            <tr>
                                <td><?php echo $num; ?></td>
                                <td><?php echo $obj->VISIT_PATIENT; ?></td>
                                <td><?php echo $obj->VISIT_PATIENTNUM; ?></td>
                                <td><?php echo date( "d-m-Y",strtotime($obj->VISIT_DATE)); ?></td>
                                <td><?php echo $obj->VISIT_CASHAMT;?></td>
                                <td>

                                    <button type="submit" class="btn btn-primary" onclick="document.getElementById('keys').value='<?php echo $obj->VISIT_CODE;?>';document.getElementById('views').value='details';document.getElementById('viewpage').value='tdetails';"> Details</button>
