    <div class="main-content">
        ...
        <div class="page-wrapper">
                ...
                <div class="form-group">
                      <div class="col-sm-6">
                            ...
                            <select class="form-control select2" name="depcode" id="depcode">
                                ...
                                <?php
                                while ($dept = $stmtdepartment->FetchNextObject()){?>
               ...
               <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-6">
                                ...
                                <label><input type="checkbox" id="servicecode" name="syscheckbox[<?php echo $objsubft->SERV_CODE ; ?> ]" value="<?php echo $objserv->SERV_CODE ;?>" ></label>&nbsp;&nbsp; <label for="fname"><?php echo $objserv->SERV_NAME ;?></label>
                            </div>
            ...
            <div class="btn-group">
                            <div class="col-sm-12">
                                 <button type="submit" onclick="document.getElementById('view').value='';document.getElementById('viewpage').value='savemap';document.myform.submit;" class="btn btn-info"><i class="fa fa-plus-circle"></i> Save </button>
