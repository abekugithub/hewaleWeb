    ...
    <div class="page-wrapper">
        ...
        <div class="page form">
            <div class="moduletitle">
                <div class="moduletitleupper">Manage X-ray Pricing</div>
            </div>
            <div class="row">
                <div class="col-sm-4">
                    <label>X-ray</label><br />
                    <select name="xray" id="xray" class="form-control select2" tabindex="2">
                        <option value="<?php echo $xray; ?>">-- Select X-ray --</option>
                        <?php while($obj = $stmtservicelov->FetchNextObject()){  ?>
                            <option value="<?php echo $obj->X_CODE.'@@@'.$obj->X_NAME ;?>" <?php echo (($obj->X_CODE == $xray)?'selected':'' )?> ><?php echo $obj->X_NAME ;?></option>
                        <?php } ?>
                    </select>
                </div>
                <div class="col-sm-4">
