            ...
            <div class="page form">
               ...
               <input type="text" class="form-control" id="address" name="address" value="<?php echo $address;?>" autocomplete="off">
                            ...
                            <div class="col-sm-12">
                                ...
                                <select class="form-control select2" multiple name="department[]" id="department[]">
                                    ...
                                    while ($dept = $stmtdepartment->FetchNextObj()){?>
                                        <option value="<?php echo $dept->DEPT_CODE; ?>" <?php if (is_array($dept_split)){ foreach ($dept_split as $deptm){echo ($deptm==$dept->DEPT_CODE)?'selected':'';}} ?> >
                        ...
                        <div class="btn-group" style="padding-top:20px;">
                            <div class="col-sm-12">
                                 <button type="submit" onclick="document.getElementById('keys').value='<?php echo $keys ;?>';document.getElementById('data').value='<?php echo $data ;?>';document.getElementById('view').value='';document.getElementById('viewpage').value='saveedit';document.myform.submit;" class="btn btn-info"><i class="fa fa-plus-circle"></i> Save </button>
                                ...
                                <ul>
                                    ...
                                    ?>
                                        ...
                                        <li class="has-children">
                                            <input type="checkbox" id="node-0-<?php echo $num ;?>" name="group-<?php echo $num ;?>" id="group-<?php echo $num ;?>" checked>
				...
				$stmtt = $engine->getUserUnitAccess($keys,$objsubft->MENUDET_CODE);
