        ...
        <div class="page-wrapper">
            ...
            <div class="page form">
                <div class="moduletitle">
                    <div class="moduletitleupper">Manage Accommodation - Pricing </div>
                </div>
					...
					<div class="col-sm-4">
						...
						<select name="accommodation" id="accommodation" class="form-control" tabindex="2"><option value="<?php echo $accommodation; ?>"> -- Select bed --</option>
							<?php while($obj = $stmtaccommodationlov->FetchNextObject()){  ?>
							<option value="<?php echo $obj->BED_CODE.'@@@'.$obj->BED_NAME.', '.$obj->BED_WARDNAME ;?>" <?php echo (($obj->BED_CODE == $accommodation)?'selected':'' )?> ><?php echo $obj->BED_NAME.', '.$obj->BED_WARDNAME ;?></option>
							<?php } ?> 
