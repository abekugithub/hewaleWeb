        ...
        <div class="page-wrapper">
            ...
            <div class="page form">
                <div class="moduletitle" style="margin-bottom:0px;">
                    <div class="moduletitleupper">ACCOMMODATION - PRICING</div>
                </div>
                   ...
                   echo '<tr>
						...
						<div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><button type="submit" onclick="document.getElementById(\'view\').value=\'edit\';document.getElementById(\'keys\').value=\''.$obj->PS_CODE.'\';document.getElementById(\'viewpage\').value=\'edit\';document.myform.submit;">Edit</button></li>
                                </ul>
                            </div>
