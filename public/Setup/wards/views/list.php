        ...
        <div class="page-wrapper">
            ...
            <div class="page form">
                <div class="moduletitle" style="margin-bottom:0px;">
                    <div class="moduletitleupper">SETUP - WARDS</div>
                </div>
                 ...
                 $num = 1;
                  if($paging->total_rows > 0 ){
                   ...
                   echo '<tr>
                        <td>'.$num.'</td>
                        <td>'.$obj->WARD_NAME.'</td>
						<td>'.$obj->WARD_GENDER.'</td>
                        <td>'.$obj->WARD_CAPACITY.'</td>
						<td>'.$obj->WARD_OCCUPPIED.'</td>
						<td>'.$obj->WARD_EMPTY.'</td>
                       	<td> 
						...
						<div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><button type="submit" onclick="document.getElementById(\'view\').value=\'edit\';document.getElementById(\'keys\').value=\''.$obj->WARD_CODE.'\';document.getElementById(\'viewpage\').value=\'edit\';document.myform.submit;">Edit</button></li>
                                </ul>
                            </div>
