        ...
        <div class="page-wrapper">
            ...
            <div class="page form">
                <div class="moduletitle">
                    <div class="moduletitleupper">Ward Setup - Add </div>
                </div>
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-3">
						...
						<select name="gender" class="form-control"><option value=''>--Select Gender--</option><option value='Male'>Male</option><option value='Female'>Female</option><option value='Any'>Any</option></select>
                ...
                <div class="col-sm-12">
                    ...
                    <button type="submit" onclick="document.getElementById('viewpage').value='saveward';document.myform.submit;" class="btn btn-success">Save</button>
