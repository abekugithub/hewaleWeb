        ...
        <div class="page-wrapper">
            ...
            <div class="page form">
                <div class="moduletitle">
                    <div class="moduletitleupper">SETUP BED - EDIT </div>
                </div>
                ...
                <div class="col-sm-12">
                    ...
                    <button type="submit" onclick="document.getElementById('viewpage').value='editbed';document.myform.submit;" class="btn btn-success">Apply Changes</button>
