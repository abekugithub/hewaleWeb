...
*/
 ...
 class excelReport
 {
	...
	/*  $this->objExcel->getActiveSheet()->getColumnDimension('F')->setWidth(20);
	  ...
	  $this->objExcel->getActiveSheet()->SetCellValue('B1', 'FULL NAME');
	  $this->objExcel->getActiveSheet()->SetCellValue('C1', 'HEWALE NUMBER');
	  $this->objExcel->getActiveSheet()->SetCellValue('D1', 'VISIT CODE');
	  $this->objExcel->getActiveSheet()->SetCellValue('E1', 'DATE');
...
$this->objExcel->getActiveSheet()->setPageMargins($this->PageMargins);
	...
	// Redirect output to a client's web browser (Excel2007)
	  	...
	  	header('Content-Disposition: attachment;filename="'."Doctor Consultation".'.xlsx"');
