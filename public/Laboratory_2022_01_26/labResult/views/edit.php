			 ...
			 if($stmtlist->RecordCount()>0){	
				...
				while($obj = $stmtlist->FetchNextObject()){
					echo '
						...
						<td>'.$obj->LT_RMK.'</td>
						<td><button type="submit" class="btn btn-info btn-square" onclick="document.getElementById(\'s\').value=\'add\';document.getElementById(\'keys\').value=\''.$obj->LT_CODE.'\';document.getElementById(\'viewpage\').value=\'add\';document.myform.submit;">Take Specimen</button></td>					 
