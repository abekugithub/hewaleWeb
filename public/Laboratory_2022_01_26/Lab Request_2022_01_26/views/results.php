...
.rowinfo{
 ...
 <div class="page-wrapper">
     ...
     <input type="hidden" class="form-control" id="cde" name="cde" value="<?php echo $cde; ?>" readonly>
     <input type="hidden" class="form-control" id="test" name="test" value="<?php echo $test; ?>" readonly>

     <input type="hidden" class="form-control" id="testname" name="testname" value="<?php echo $testname; ?>" readonly>
     <input type="hidden" class="form-control" id="discpline" name="discpline" value="<?php echo $discpline; ?>" readonly>
     <input type="hidden" class="form-control" id="discpline" name="requestcode" value="<?php echo $requestcode; ?>" readonly>
      

     
     <div class="moduletitle" style="margin-bottom:0px;">
            <div class="moduletitleupper">Lab Results</div>
            <button class="btn btn-dark pull-right" onclick="document.getElementById('view').value='labdetails';document.myform.submit;" style="font-size:15px; padding-top:-10px; line-height:1.3em;  margin-top:-40px;" title="Back" formnovalidate>Back</button>
        ...
        <div class="col-sm-12 salesoptblock">
                <div class="col-sm-8 salesoptselect">
                    <div class="form row">
                        ...
                        <label class="form-label required">Request Code: <?php echo ($packagecode?$packagecode:'');?></label>
                        ...
                        <div class="col-sm-6 form-group">
                        <label class="form-label required">Requester:  <?php echo ($medic?$medic:'N/A') ;?> MD</label>
                           
                        </div>
                        <div class="col-sm-6 form-group">
                        <label class="form-label required">Test:  <?php echo ($testname?$testname:'N/A') ;?> </label>
                           
                        </div>
                        <div class="col-sm-6 form-group">
                        <label class="form-label required">Displine:  <?php echo ($discpline?$discpline:'N/A') ;?> </label>
            ...
            <div class="btn-group pull-right">
                ...
                <button type="button" class="btn btn-info btn-square"  onclick="document.getElementById('viewpage').value='attached';document.myform.submit();">Attach</button>
                <button type="button" class="btn btn-success btn-square"  onclick="document.getElementById('viewpage').value='saveresults';document.myform.submit();">Save</button>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    $num = 1;
					$i =  1;
                    if($stmtlisttestresults->Recordcount() > 0 ){
					while ($obj = $stmtlisttestresults->FetchNextObject()){
                    
                   echo '<tr>
						
						    <td>'.$num.'</td>
                            <td>'.$obj->LTMI_LTCODE.'</td>
                            					
						<td>
						'.(($obj->LTMI_FILENAME =='')?'Pending':'<a href= "media/download.php?filename='. ATTACH_LABRESULT.'/'.$obj->LTMI_FILENAME.'"><button type="button" class="btn btn-info btn-square" onclick="document.getElementById(\'view\').value=\'labdetails\';document.getElementById(\'viewpage\').value=\'\';">Download Results</button></a>').'
                        </td>	
                        
                        <td> 
						
						 <button type="submit" class="btn btn-info btn-square" onclick="document.getElementById(\'view\').value=\'\';document.getElementById(\'cde\').value=\''.$obj->LTMI_ID.'\';document.getElementById(\'viewpage\').value=\'removeresults\';document.myform.submit;">Remove </button>
