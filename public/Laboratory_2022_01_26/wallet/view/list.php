            	...
            	<div class="col-sm-8">
            		...
            		<div class="row">
            			 <div class="col-sm-12" style="margin-top: 20px;">
            			 	<h3 class="title">Transfer Funds</h3>
            			 </div>
            			<div class="col-sm-12" style="margin-top: 20px;">
...
<span >Smartpay</span>
                	<br>	<span style="font-size: 10px;">You can transfer funds into your smartpay account.</span></div>
                </div>
...
<span >Mobile Money</span>
                	<br>	<span style="font-size: 10px;">You can transfer funds into your mobile money account. ie MTN, TIGO, AIRTEL etc.</span></div>
                </div>
             </h4>
        </div>
        <div id="collapseTwo" class="panel-collapse collapse">
            ...
            <div class="row">
            	<div class="col-sm-12">
            		 <label for="gender">Payment Option</label>
...
<span >Credit & Debit Card</span>
                	<br>	<span style="font-size: 10px;">You can transfer funds into your credit & debit card. ie VISA, MASTER etc.</span></div>
                </div>
             </h4>
        </div>
