        ...
        <div class="col-sm-12 salesoptblock">
            ...
            <!--
                ...
                <div class="col-sm-4 required">
                    ...
                    <select name="sample" id="sample" class="form-control" tabindex="2"><option value="<?php echo $sample; ?>"> -- Select Sample --</option>
				<?php while($obj = $stmtspecimen->FetchNextObject()){  ?>
				<option value="<?php echo $obj->SP_CODE.'@@@'.$obj->SP_NAME ;?>" <?php echo (($obj->SP_CODE == $sample)?'selected':'' )?> ><?php echo $obj->SP_NAME ;?></option>
				<?php } ?> 
                ...
                <div class="col-sm-4 required">
                    <label for="othername">Label</label>
					    <input type="text" name="label" id="file" class="form-control">
                </div>
                <div class="col-sm-4 required">
                    <label for="othername">Volume</label>
					    <input type="text" name="volume" id="file" class="form-control">
                </div>
