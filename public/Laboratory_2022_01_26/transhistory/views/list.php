    ...
    <div class="page-wrapper">
        ...
        <div class="page form">
            <div class="moduletitle" style="margin-bottom:0px;">
                ...
                <div class="moduletitleupper">Transaction History</div> 
            </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    if($paging->total_rows > 0 ){
						   ...
						   if($obj->LTM_STATUS == '3'){$labstatus = 'Paid';}elseif($obj->LTM_STATUS == '4'){$labstatus = 'Specimen Taken';}elseif($obj->LTM_STATUS == '5'){$labstatus = 'Processing';}elseif($obj->LTM_STATUS == '6'){$labstatus = 'Result Ready';}elseif($obj->LTM_STATUS == '7'){$labstatus = 'Signed Off';}
