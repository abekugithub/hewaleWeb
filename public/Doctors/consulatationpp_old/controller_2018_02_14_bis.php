	...
	case "saveconsultation":
		    ...
		    if (!empty($consstatus)){
                ...
                if($consstatus[0] == 'SER0004'){    //Vitals
                    ...
                    $code = '006';
                    $desc = "Your consulation was completed successfully. Refer to your prescriptions module if any.";
					$menudetailscode = '0000'; //No notification to other module
                }elseif($consstatus[0] == 'SER0016'){   //Incomplete
                    $code = '016' ;
                    $desc = "Your consulation was incomplete. Refer to your prescription list to see any prescribe medications.";
					$menudetailscode = '0000'; //No notification to other module
