	...
	case "saveconsultation":
		    ...
		    if (!empty($consstatus)){
                ...
                if($consstatus[0] == 'SER0004'){    //Vitals
                    ...
                    $desc = "You were prescribed some medications. Refer to the pharmacy module to see your prescription. For any assistance, call (+233)0203618204.";
                    ...
                    $objprsc = $patientCls->getPrescriptionInfo($visitcode);
                    if(!empty($objprsc->PRESC_PATIENTNUM)){
                    $desc = "You were prescribed some medications. Refer to the pharmacy module to see your prescription. Help Line (+233)0203618204.";
                    }
					$menudetailscode = '0000'; //No notification to other module
                }
		   ...
		   //End update for active consultation set
                 ...
                 if($code == '016' || $code == '006' ){
                    ...
                    */
                     //End sending sms
                        ...
                        $pmessage = 'Your consultation was addressed by Dr. '.$usrname.'. For any assistance, call (+233)0203618204' ;
                    }}
                ...
                $docsmsmsg = 'Dr. '.$usrname.' is referring a Patient ('.$patientobj->PATCON_FULLNAME.') to you. Sign up to Hewale to view the Patients record electronically. goo.gl/fxFjRN';
