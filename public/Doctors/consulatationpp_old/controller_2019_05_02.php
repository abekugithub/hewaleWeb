	...
	case "saveconsultation":
		    ...
		    if (!empty($consstatus)){
                ...
                if($consstatus[0] == 'SER0004'){    //Vitals
                    ...
                    $desc = "You were prescribed some medications. Refer to the pharmacy module to see your prescription. For any assistance, call (+233)0202098297.";
                    ...
                    $objprsc = $patientCls->getPrescriptionInfo($visitcode);
                    if(!empty($objprsc->PRESC_PATIENTNUM)){
                    $desc = "You were prescribed some medications. Refer to the pharmacy module to see your prescription. Help Line (+233)0202098297.";
                    }
					$menudetailscode = '0000'; //No notification to other module
                }
                 ...
                 if($code == '016' || $code == '006' ){
                    ...
                    */
                     //End sending sms
                        ...
                        $pmessage = 'Your consultation was addressed by Dr. '.$usrname.'. For any assistance, call (+233)0202098297' ;
                    }}
