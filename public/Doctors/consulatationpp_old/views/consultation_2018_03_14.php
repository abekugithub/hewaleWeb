                    ...
                    <div class="col-sm-12 clientself-video" style="left:-15px; top:-25px">
                        ...
                        <?php //if(!empty($easyrtcid)){?>
                            <div id="otherClients"  class="btn btn-info myspecialform startPMsg" style="width:180px; height:30px; padding-top:10px; padding-bottom:20px !important; color:#fff !important; font-size:15px; font-weight:bold;" onClick="geteasyrtcid()"> Start Video Call</div>
                             ...
                             <div id="otherClients"  class="btn btn-danger myspecialform endPMsg" style="width:180px; height:30px; padding-top:10px; padding-bottom:20px !important; color:#fff !important; font-size:15px; font-weight:bold;" onClick="endeasyrtccall()"> End Video Call</div>
                        <?php //} ?>
               ...
               <button type="button" id="otherClients" class="submitchat" onClick="geteasyrtcchatid()"><i class="fa fa-send"></i></button>
                <?php } ?>
                            ...
                            <div id="video" class="tab-pane fade in active">
                                <div style="position:relative;float:left; top:-328px;">
...
<script type="text/javascript">
	...
	function endeasyrtccall(){
		...
		$('.endPMsg').hide();
		$('.startPMsg').show();
		alert("Video call ended successfully.");
		}
