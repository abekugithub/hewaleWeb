                        ...
                        <li class=""><a data-toggle="tab" href="#phone" onClick="phonecall()"><i class="fa fa-phone" aria-hidden="true" ></i></a></li>
                            ...
                            <div id="chat" class="tab-pane fade in active">
                                        ...
                                        while($obj = $msgdetails->FetchNextObject()){?>
                                            <?php if($obj->CH_SENDER_CODE == $usrcode){ ?>
                                                <div class="speech-bubble-rt">
                                                    <div class="speech-bubble-rt speech-bubble-right" id="conversation2"> <?php echo $encaes->decrypt($obj->CH_MSG) ;?> </div>
                                                </div>
                                            <?php }else{ ?>
                                                <div class="speech-bubble-lt">
                                                    <div class=" speech-bubble-lt speech-bubble-left" id="conversation"> <?php echo $encaes->decrypt($obj->CH_MSG) ;?> </div>
                                                </div>
                                            <?php } ?>
                                        <?php } }?>
                                    </div>
                                ...
                                <div class="col-sm-12 chattextarea">
                                    <textarea name="chatmsg" id="chatmsg" class="chatmsg" cols="" placeholder="message..."></textarea>
               ...
               <button type="button" id="otherClients" class="submitchat" onClick="geteasyrtcchatid()"><i class="fa fa-send"></i></button>
                <?php } ?>
                    ...
                    <div class="tabish pull-right">
                        ...
                        <button type="button" class="btn btn-info btn-square" onclick='' data-toggle="modal" data-target="#veiwallergies">Allergies</button>
                        ...
                        <div class="col-sm-12 required">
                            ...
                            <button type="button" class="btn btn-primary" id="addcomplain" style="margin: 24px 0 0 0;">Add</button>
                                        ...
                                        <div id="presciption" class="tab-pane fade">
                                            ...
                                            <div class="col-sm-2" style="width: 16%; padding-left:0px !important;">
                                                <label>Days</label>
                                            ...
                                            <div class="col-sm-5" style="width: 32%">
                                                ...
                                                <select name="route" id="route" class="form-control select2">
                                                    <option value="all" selected disabled>Select Route</option>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="col-sm-12 ">
                    <?php
                    $stmtallergy = $sql->Execute($sql->Prepare("SELECT PATIENT_ALLERGIES FROM hms_patient WHERE PATIENT_PATIENTNUM=".$sql->Param('a')." "),array($patientnum));
                    print $sql->ErrorMsg();
                    if ($stmtallergy->RecordCount()>0){   
                    $obja = $stmtallergy->FetchNextObject();
                    //print_r($obja);
                    $allergy = $obja->PATIENT_ALLERGIES;
                    if(!empty($allergy)){
                    echo $allergy;
                        }else{
                            echo 'No Allergy.';
