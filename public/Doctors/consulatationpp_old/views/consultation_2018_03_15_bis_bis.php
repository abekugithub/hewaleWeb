                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12 clientself-video" style="left:-15px; top:-25px">
                        ...
                        <?php //if(!empty($easyrtcid)){?>
                            <div id="otherClients"  class="btn btn-info myspecialform startPMsg" style="width:180px; height:30px; padding-top:10px; padding-bottom:20px !important; color:#fff !important; font-size:15px; font-weight:bold;" onClick="geteasyrtcid()"> Start Video Call</div>
                             ...
                             <div id="otherClients"  class="btn btn-danger myspecialform endPMsg" style="width:180px; height:30px; padding-top:10px; padding-bottom:20px !important; color:#fff !important; font-size:15px; font-weight:bold;" onClick="endeasyrtccall()"> End Call</div>
                              ...
                              <div id="otherClients"  class="btn btn-info myspecialform startPCall2" style="width:180px; height:30px; padding-top:10px; padding-bottom:20px !important; color:#fff !important; font-size:15px; font-weight:bold;" onClick="geteasyrtcid()"> Start Phone Call</div>
