    ...
    <div class="page-wrapper">
        <div class="page form">
            <div class="moduletitle" style="padding-bottom:0 !important">
                ...
                <div class="moduletitleupper" style="font-size:17px; font-weight:500;">Consultation for <?php echo  $patientname ;?> [ <?php echo  $patientnum ;?>]
                    <span class="timer timerwell2"></span>

                    <span class="pull-right">

 <span style="font-size:16px; color:#555">Patient in queue: <?php echo (($totalpatient > 0)?$totalpatient:'0'); ?></span>
            ...
            <div class="col-sm-2">
                ...
                <div class="form-group">
                    <div class="col-sm-12 client-info">
                        ...
                        <label style="width: 4em;">Age:</label><span><?php echo (($patientage == 0)?'':$patientage); ?></span><br>
                        <label style="width: 4em;">Gender:</label><span><?php echo $patientgender?></span>
                        <div id="connectControls" style="display:none"><div id="iam"></div></div>
                                        ...
                                        while($obj = $msgdetails->FetchNextObject()){?>
                                            <?php if($obj->CH_SENDER_CODE == $usrcode){ ?>
                                                <div class="speech-bubble-rt">
                                                    <div class="speech-bubble-rt speech-bubble-right" id="conversation2"> <?php echo $encaes->decrypt($obj->CH_MSG) ;?><div class="formatchatdate"><?php echo date("d M Y H:i",strtotime($obj->CH_DATE)) ;?></div></div>
                                                </div>
                                            <?php }else{ ?>
                ...
                <?php } ?>
                            ...
                            <div id="video" class="tab-pane fade in">
                                <div class="callervideoview">
                                    <video autoplay id="callerVideo" width="210" height="300"></video>
                                </div>
                            </div>
                            <div id="phone" >
                                                ...
                                                <div class="col-sm-12 required">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <select name="actiontype" id="actiontype" class="form-control select2 finalaction" tabindex="2">
                                                           ...
                                                           <label class="control-label">Specialist Contact Number</label>
                                                                    <div class="controls">
                                                    ...
                                                    <div class="control-group span4 reff2" style="margin-bottom:10px;"> 
                                                           <label class="control-label">Specialists Name</label>
                                                            ...
                                                            <select name="specialistphone" id="specialistphone" class="form-control select2 finalaction">
                                                                    ...
                                                                    ?>
                                                                    <option value="<?php echo $objspecdetail->USR_PHONENO.','.$objspecdetail->USR_CODE; ?>"><?php echo $objspecdetail->USR_OTHERNAME.' '.$objspecdetail->USR_SURNAME.' ('.$objspecdetail->MP_SPECIALISATION.')'; ?></option>
                                                                    <?php
                                                                    } ?>
                                                            </select>
                                                    ...
                                                    <div class="control-group span4 reff3">
                                                                    <label class="control-label">Patient Referral Note (Will be sent to the patient):</label>
                                                                    <div class="controls">
                                                    ...
                                                    <div id="xray" class="tab-pane fade">
                                                            ...
                                                            <div class="control-group span6">
                                                                ...
                                                                <div class="controls">
                                                                    <select name="xrayopt" id="xrayopt" class="form-control select2" tabindex="2">
                                                                        <option value="all" selected disabled>-- Select radiology type --</option>
                                                                        <?php while($objxray = $stmtxray->FetchNextObject()){  ?>
                                                                            <option value="<?php echo $objxray->X_CODE.'@@@'.$objxray->X_NAME ; ?>" <?php echo (($objdpt->X_CODE == $xrayopt)?'selected':'' )?> ><?php echo $objxray->X_NAME .' ('.(($objxray->X_TYPE == 1)?'X-Ray':'Ultrasound') .') ' ;?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <table class="table table-responsive table-bordered" id="tblxray">
                                                            ...
                                                            while ($objx = $stmtx->FetchNextObject()){
                                                                ...
                                                                <tr>
                                                                    <td><?php echo $n++; ?></td>
                                                                    <td><?php echo $encaes->decrypt($objx->XT_TESTNAME); ?></td>
                                                                    <td><?php echo $encaes->decrypt($objx->XT_RMK); ?></td>
                                                                    <td>
                                            ...
                                            <table class="table table-responsive table-bordered" id="tbldiagnosis">
                                                ...
                                                while ($objdiag = $stmtdiag->FetchNextObject()){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo (($obj->DIA_TYPE == 1)?'Final':'Provisional'); ?></td>
                                                        <td>
		  ...
		  */
		  var patientcode = $('#patientcode').val();
		        $.ajax({
			        type: 'POST',
                    dataType:'json',
					url: 'public/Doctors/consulatationpp/model/getpatienteasyrtcid.php?easyrtctype='+easyrtctype,
