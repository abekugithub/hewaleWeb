            ...
            <table class="table table-hover">
                ...
                if($paging->total_rows > 0 ){
                    ...
                    while(!$rs->EOF){
                        ...
                        if($requestdetails->REQU_CONSULTTYPE == '1'){$medium = 'Text'; }elseif($requestdetails->REQU_CONSULTTYPE == '2'){$medium = 'Audio';}elseif($requestdetails->REQU_CONSULTTYPE == '3'){$medium = 'Video' ;}else{$medium = 'Text';}
