    ...
    <div class="page-wrapper">
        <div class="page form">
            ...
            <div class="col-sm-12 paddingclose personalinfo">
                <div class="col-sm-2">
                    <div class="id-photo">
                        <img src="<?php echo(($patientphoto))?$patientphoto:'media/img/avatar.png';?>" alt="" id="prevphoto" style="width:100% !important; margin:0px !important;"></div>
                        
                        <div class="form-group">
                       <div class="col-sm-12 clientself-video" style="left:-15px; top:-25px">
               <?php $linkview = 'index.php?pg='.md5('Doctors').'&amp;option='.md5('Premium Service').'&uiid='.md5('1_pop').'&viewpage=getpatientgeolocation&view=maplocation&keys='.$patientcode; ?>     
             <div class="btn btn-info" style="width:180px; height:30px; padding-top:10px; padding-bottom:20px !important; color:#fff !important; font-size:15px; font-weight:bold; margin-top:30px" onClick="CallSmallerWindow('<?php echo $linkview;?>')"> Show Location</div>
...
<!--                        <th>Password</th>-->
    ...
    while($objsmt = $stmtpat->FetchNextObject()){
            ...
            echo '
                  <td >'.$num++.'</td> 
                  <td >'.date("d/m/Y",strtotime($objsmt->CONS_DATE)).'</td> 
				  <td >'.$objsmt->CONS_DOCTORNAME.'</td>
				  <td >'.(($objsmt->CONS_STATUS == 1)?'Pending':(($objsmt->CONS_STATUS == 2)?'Incomplete':'Complete')).'</td>
