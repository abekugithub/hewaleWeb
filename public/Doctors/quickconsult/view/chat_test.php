            ...
            <div class="form-group">
             ...
             <div id="chat" class="tab-pane fade in active">
                <div class="col-sm-12 chatarea" id="chatareaindoc">
                 <div id="speech-bubble">
                  ...
                  <div class="speech-bubble-rt">
                    <div class="speech-bubble-rt speech-bubble-right" id="conversation2"> <?php echo $encaes->decrypt($obj->CHT_MSG) ;?> </div>
                  </div>
                  <?php }else{ ?>
                  <div class="speech-bubble-lt">
                 <div class="speech-bubble-lt speech-bubble-left" id="conversation"> <?php echo $encaes->decrypt($obj->CHT_MSG) ;?> </div>
                  </div>
                  <?php } ?>
                  <?php } }?>
                  </div>
                ...
                <div class="col-sm-12 chattextarea">
                  <textarea name="chatmsg" id="chatmsg" class="chatmsg" cols="" placeholder="Type message..."></textarea>
...
function sendStuffWS(otherEasyrtcid) {
  ...
  easyrtc.sendDataWS(otherEasyrtcid, "message",  text, this.ackhandler);
...
function ackhandler(msg){
                if (msg.msgType === "error") {
                    ...
                    console.log(msg.msgData.errorText);
                }elseif(msg.msgType === "ack"){ 
                   // alert('Welcome'); setTimeout(function(){ alert("Hello"); }, 3000);
                   alert('hi');
                    }
