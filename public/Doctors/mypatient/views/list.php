    ...
    <div class="page-wrapper">
        ...
        <div class="page form">
            <div class="moduletitle" style="margin-bottom:0px;">
                <div class="moduletitleupper">My Patients</div>
            </div>
            ...
            <table class="table table-hover">
                ...
                if($paging->total_rows > 0 ){
                    ...
                    while(!$rs->EOF){
                        ...
                        $objd = $patientCls->getPatientDetails($obj->CONS_PATIENTNUM);
                        echo '<tr>
                        <td>'.$num.'</td>
						...
						<div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><button type="submit" data-toggle="modal" data-target="#addDesp" onclick="document.getElementById(\'view\').value=\'patientdetails\';document.getElementById(\'keys\').value=\''.$obj->CONS_PATIENTNUM.'\';document.getElementById(\'viewpage\').value=\'viewpatient\';document.myform.submit;">View Patient</button></li>
<li><button type="submit" data-toggle="modal" data-target="#addDesp" onclick="document.getElementById(\'view\').value=\'excuseduty\';document.getElementById(\'keys\').value=\''.$obj->CONS_PATIENTNUM.'\';document.getElementById(\'viewpage\').value=\'viewpatient\';document.myform.submit;">Excuse Duty</button></li>
