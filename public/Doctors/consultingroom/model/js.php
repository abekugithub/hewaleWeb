...
<script>
    ...
    function deleteComplains(para, type) {
        $.ajax({
            type: 'POST',
            url: '../../../../public/Doctors/consultingroom/model/removeComplains.php',
            data: {
                'comcode': para,
                'type': type,
...
//                    }
    ...
    function fetchComplains(patientnum, visitcode) {
        $.ajax({
            type: 'POST',
            url: '../../../../public/Doctors/consultingroom/model/fetchComplains.php',
    ...
    setInterval( function() {
        $.ajax({
            type: 'POST',
            url: '../../../../public/Doctors/consultingroom/model/consultationupdate.php',
            dataType: 'json',
    ...
    /*setInterval( function() {
        $.ajax({
            type: 'POST',
            url: '../../../../public/Doctors/consultingroom/model/numberconsultupdate.php',
            dataType: 'json',
            data: '',
            success: function(e){
                $('.btnnumqueue').html(e)
    ...
    $(document).ready(function(e){ 
        ...
        $('#addcomplain').click(function (e) {
            ...
            if (complain != '') {
                $.ajax({
                    type: 'POST',
                    url: '../../../../public/Doctors/consultingroom/model/saveComplains.php',
                    data: {
...
//                    $('#storyline').hide();
        ...
        $('#addlabs').click(function (e) {
            ...
            if (labs != '') {
                $.ajax({
                    type: 'POST',
                    url: '../../../../public/Doctors/consultingroom/model/saveLabs.php',
                    data: {
                        'testcode': lab[0],
                        'testname': lab[1],
                        'dicscode': lab[2],
        ...
        $('#addxray').click(function (e) {
            ...
            if (xray != '') {
                $.ajax({
                    type: 'POST',
                    url: '../../../../public/Doctors/consultingroom/model/savexrays.php',
                    data: {
                        'xraycode': xray[0],
                        'xrayname': xray[1],
                        'dicscode': xray[2],
        ...
        $('#adddiagnosis').click(function (e) {
            ...
            if (diagnosis != '') {
                $.ajax({
                    type: 'POST',
                    url: '../../../../public/Doctors/consultingroom/model/saveDiagnosis.php',
                    data: {
        ...
        $('#addprescription').click(function (e) {
            ...
            if (drug != '') {
                $.ajax({
                    type: 'POST',
                    url: '../../../../public/Doctors/consultingroom/model/savePrescription.php',
                    data: {
                        'drugcode': drg[0],
                        'drugname': drg[1],
                        'drugdose': drg[2],
...
//                $('select#route option:first-child').attr("selected", "selected");
        ...
        $('#addphyexams').click(function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '../../../../public/Doctors/consultingroom/model/savePhysicalExams.php',
                data: data,
                success: function (e) {
                    if(e.match('<tr>')){
...
*/
  ...
  /*       setInterval( function() {
		 ...
		 var patientcode = $('#patientcode').val();
		            $.ajax({
			        type: 'POST',
					url: '../../../../public/Doctors/consultingroom/model/fetchchat.php',
					dataType: 'json',
...
$('#chroniques').click(function (e) {
            ...
            e.preventDefault();
            //var data = $('#myform').serializeArray();
            var txtarea = $('#txtcontent').val();
            var condtype = $('#condtype').val();
            var patientnum = $('#patientnum').val();
            
            $.ajax({
                type: 'POST',
                url: '../../../../public/Doctors/consultingroom/model/saveAllergies.php',
                data: {
                  "txtarea": txtarea,
                  "condtype":condtype,
...
$('.finalaction1').change(function(){
    var actiontype = $('#refferalType').val();
    if(actiontype == 'specialist'){
       $('.reff').show();
       $('.reff3').show();
       $('.reff2').hide();
       $('.reffHospital').hide();
...
$('#refnote').keyup(function() {
    ...
    $('.chatmsgcount').keyup(function () { 
     ...
     /* 
     * This script cancels a consultation request
     */
    
    $('#savebtn').on('click',function(){ 
       // var visitcode = $(this)
           // var visitcode = $(this).data('id'); 
            var cancelreason = $('#canceltext').val();
            //var visitcode = $('#visitcode').val();
            $.ajax({
            type: 'POST',
            url: '../../../../public/Doctors/consultingroom/model/cancelconsultation.php',
            dataType: 'json',
            data: {
	...
	$.ajax({
			type: 'POST',
			url: '../../../../public/Doctors/consultingroom/model/deleteAllergies.php',
			data: {
                  "patientnum":patientnum
                  },
			success: function (e) {
...
function deleteChroniques(){
	...
	$.ajax({
			type: 'POST',
			url: '../../../../public/Doctors/consultingroom/model/deleteChroniques.php',
			data: {
                  "patientnum":patientnum
                  },
			success: function (e) {
    ...
    function deletePhysicalExams(e){
        ...
        $.ajax({
            type: 'POST',
            url: '../../../../public/Doctors/consultingroom/model/deletePhysicalExams.php',
