<div class="main-content" >
    <div class="page-wrapper">
        <div class="page form notepaper">
            <div class="moduletitle">
                <div class="moduletitleupper">Mwwedical History<span class="pull-right">
                    ...
                    <div class="table-title">
                        ...
                        <div class="col-sm-5">
                            <div class="input-group">
                                <input type="text" tabindex="1" value="<?php echo $fdhistory; ?>" class="form-control square-input" name="fdhistory" placeholder="Enter History to Search"/>
                                <span class="input-group-btn">
                                            <button type="submit" onclick="document.getElementById('view').value='history';document.getElementById('viewpage').value='searchitem';document.myform.submit;" class="btn btn-default btn-gyn-search"> <i class="fa fa-search"></i> </button>
                                        </span>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="input-group">
                                <button type="submit" onclick="document.getElementById('view').value='history';
