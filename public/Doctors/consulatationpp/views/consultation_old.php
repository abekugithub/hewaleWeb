...
<!--                        <input type="hidden" class="form-control" id="visitcode" name="visitcode" value="--><?php //echo $visitcode; ?><!--">-->
                        ...
                        <?php echo (($onlinestate == 1)?' <i class="fa fa-circle onlinetrue" aria-hidden="true"></i> <span class="onlinestate"> Online</span>':'<i class="fa fa-circle onlinefalse" aria-hidden="true"></i> <span class="onlinestate"> Offline</span>' ); ?>
                    ...
                    <div class="col-sm-12 clientself-video" style="left:-15px; top:-25px">
                        ...
                        <?php if(!empty($easyrtcid)){?>
                            <div id="otherClients"  class="btn btn-info myspecialform" style="width:180px; height:30px; padding-top:10px; padding-bottom:20px !important; color:#fff !important; font-size:15px; font-weight:bold;" onClick="geteasyrtcid()')"> Start Video Call</div> 
                        <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      ...
                      <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#chat" onClick=""><i class="fa fa-comment" aria-hidden="true"></i></a></li>
                        ...
                        <li class=""><a data-toggle="tab" href="#phone"><i class="fa fa-phone" aria-hidden="true"></i></a></li>
                            ...
                            <div id="chat" class="tab-pane fade in active">
                                        ...
                                        while($obj = $msgdetails->FetchNextObject()){?>
                                            <?php if($obj->CH_SENDER_CODE == $usrcode){ ?>
                                                <div class="speech-bubble-rt">
                                                    <div class="speech-bubble-rt speech-bubble-right" id="conversation2"> <?php echo $obj->CH_MSG ;?> </div>
                                                </div>
                                            <?php }else{ ?>
                                                <div class="speech-bubble-lt">
                                                    <div class=" speech-bubble-lt speech-bubble-left" id="conversation"> <?php echo $obj->CH_MSG ;?> </div>
                                                </div>
                                            <?php } ?>
                                        <?php } }?>
                                    </div>
                                ...
                                <div class="col-sm-12 chattextarea">
                                    ...
                                    <?php if(!empty($easyrtcid)){?>
               <button type="button" id="otherClients" class="submitchat" onClick="sendStuffWS('<?php echo $easyrtcid ;?>')"><i class="fa fa-send"></i></button>
                <?php } ?>
                            ...
                            <div id="video" class="tab-pane fade in active">
                                <div style="position:relative;float:left; top:-375px;">
                                    <video autoplay id="callerVideo" width="269" height="300"></video>
                                </div>
                            </div>
                    ...
                    <div class="tabish pull-right">
                        <button type="button" class="btn btn-info btn-square" onclick="" data-toggle="modal" data-target="#physicalexams"> Physical Exams</button>
