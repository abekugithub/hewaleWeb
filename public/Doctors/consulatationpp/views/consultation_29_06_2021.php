...
<div class="main-content">
    <div class="page-wrapper">
        <div class="page form row">
            ...
            <div class="col-sm-2">
                <div class="id-photo"> 
                    <img src="<?php echo $photourl; ?>" alt="" id="prevphoto" onerror="this.src='media/img/avatar.png'" style="width:100% !important; margin:0px !important;">
                </div>
                <div class="form-group">
                    <div class="col-sm-12 client-info">
                        ...
                        <label
                            style="width: 4em;">Age:</label><span><?php echo ($patientage < 1) ? '' : $patientage ?></span><br>
                    ...
                    <div class="col-sm-12 clientself-video" style="left:-15px; top:-25px">
                        <div id="wraperselfVideo" style="width:200px; height:220px; padding-bottom:10px !important;">
                            <video autoplay class="easyrtcMirror" id="selfVideo" muted volume="0" width="200"
                                height="200" style="float:left;"></video>
                        </div>
                        <?php //if(!empty($easyrtcid)){
                        ?>
                        <div id="otherClients" class="btn btn-info myspecialform startPMsg"
                            style="width:180px; height:30px; padding-top:10px; padding-bottom:20px !important; color:#fff !important; font-size:15px; font-weight:bold;"
                            onClick="geteasyrtcid(1)"> Start Video Call</div>

                        <div id="otherClients" class="btn btn-danger myspecialform endPMsg"
                            style="width:180px; height:30px; padding-top:10px; padding-bottom:20px !important; color:#fff !important; font-size:15px; font-weight:bold;"
                            onClick="endeasyrtccall()"> End Call</div>


                        <div id="otherClients" class="btn btn-info myspecialform startPCall2"
                            style="width:180px; height:30px; padding-top:10px; padding-bottom:20px !important; color:#fff !important; font-size:15px; font-weight:bold;"
                            onClick="geteasyrtcid(2)"> Start Phone Call</div>

                        <div id="otherClients" class="btn btn-danger myspecialform endPMsg2"
                            style="width:180px; height:30px; padding-top:10px; padding-bottom:20px !important; color:#fff !important; font-size:15px; font-weight:bold;"
                                ...
                                <div id="speech-bubble">
                                    ...
                                    <div class="speech-bubble-rt">
                                        <div class="speech-bubble-rt speech-bubble-right" id="conversation2">
                                            ...
                                            <audio id="<?php echo $obj->CH_ID."audio"; ?>" controls="controls"
                                                ...
                                                <source id="<?php echo $obj->CH_ID."audioSource"; ?>" src="">
                                                </source>
                                                Your browser does not support the audio format.
                                            </audio>

                                            <script>
                                                var decodedStringAtoB = atob(
                                                    "<?php echo $encaes->decrypt($obj->CH_AUDIO); ?>");
                                            ...
                                            <img src="http://192.168.15.55/api.hewale/uploads/chats/photos/<?php echo $obj->CH_IMAGE; ?>"
                                                alt="" width="165" style="margin-bottom: 0.5em;"> <br>
                                            <div class="formatchatdate">
                                                <div class="formatchatdate">
                                                    <?php echo date("d M Y H:i", strtotime($obj->CH_DATE)); ?>
                                                </div>
                                    ...
                                    <div class="speech-bubble-lt">
                                        <div class="speech-bubble-lt speech-bubble-left" id="conversation">
                                            ...
                                            <?php }elseif($obj->CH_TYPE == "3"){ ?>
                                            <a href="http://192.168.15.55/api.hewale/uploads/chatphotos/<?php echo $obj->CH_IMAGE; ?>"
                                                target="_blank">
                                                <img src="http://192.168.15.55/api.hewale/uploads/chatphotos/<?php echo $obj->CH_IMAGE; ?>"
                                                    alt="" width="165" style="margin-bottom: 0.5em;"> <br>
                                            </a>
    ...
    function addToConversation(who, msgType, content) {
        ...
        if (who == 'Me') {
            ...
            if (who == patienteasyrtcid) {
                $("#speech-bubble").append(
                    "<div class='speech-bubble-lt'><div class='speech-bubble-lt speech-bubble-left' id='conversation'>" +
                    content + "</div></div>");
            }
            $('#chatareaindoc').scrollTop($('#chatareaindoc')[0].scrollHeight);
