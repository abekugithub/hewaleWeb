...
<input id="new_visitcode" name="new_visitcode" value="<?php echo $new_visitcode; ?>" class="form-control" type="hidden" />
    ...
    <div class="page-wrapper">
        <div class="page form">
            <div class="moduletitle" style="padding-bottom:0 !important">
                ...
                <div class="moduletitleupper" style="font-size:17px; font-weight:500;">Consultation for
                    ...
                    <span class="pull-right">
                        ...
                        <button type="button" id="save" onclick="document.getElementById('viewpage').value='saveconsultation';document.getElementById('viewdynamic').value='consulting';document.myform.submit();" class="btn btn-warning"><i class="fa fa-plus-circle"></i> Submit &amp; Next</button>
                        ...
                        <?php } else { ?>
                            ...
                            <button type="button" class="btn btn-dark" onclick="document.getElementById('viewpage').value='cahangeconsultationstate';document.getElementById('view').value='';document.myform.submit();"><i class="fa fa-arrow-left"></i> Back </button>
            ...
            <div class="col-sm-2">
                ...
                <div class="form-group">
                    <div class="col-sm-12 client-info">
                        ...
                        <label style="width: 4em;">Age:</label><span><?php echo ($patientage < 1) ? '' : $patientage ?></span><br>
                        <label style="width: 4em;">Gender:</label><span><?php echo $patientgender ?></span>
                    ...
                    <div class="col-sm-12 clientself-video" style="left:-15px; top:-25px">
                        <div id="wraperselfVideo" style="width:200px; height:220px; padding-bottom:10px !important;">
                            <video autoplay class="easyrtcMirror" id="selfVideo" muted volume="0" width="200" height="200" style="float:left;"></video>
                        </div>
                        <?php //if(!empty($easyrtcid)){
                        ?>
                        <div id="otherClients" class="btn btn-info myspecialform startPMsg" style="width:180px; height:30px; padding-top:10px; padding-bottom:20px !important; color:#fff !important; font-size:15px; font-weight:bold;" onClick="geteasyrtcid(1)"> Start Video Call</div>

                        <div id="otherClients" class="btn btn-danger myspecialform endPMsg" style="width:180px; height:30px; padding-top:10px; padding-bottom:20px !important; color:#fff !important; font-size:15px; font-weight:bold;" onClick="endeasyrtccall()"> End Call</div>


                        <div id="otherClients" class="btn btn-info myspecialform startPCall2" style="width:180px; height:30px; padding-top:10px; padding-bottom:20px !important; color:#fff !important; font-size:15px; font-weight:bold;" onClick="geteasyrtcid(2)"> Start Phone Call</div>

                        <div id="otherClients" class="btn btn-danger myspecialform endPMsg2" style="width:180px; height:30px; padding-top:10px; padding-bottom:20px !important; color:#fff !important; font-size:15px; font-weight:bold;" onClick="endeasyrtccall2()"> End Call</div>
                        ...
                        <!--<video style="float:left;" id="self" width="200px" height="200px">
                        ...
                        <div class="form-group">
                                    ...
                                    <div class="onlineheadertop">
                                        <div align="right"> <span class="chatawe">
                                                <ul class="nav nav-tabs">
                                                    <li class="active"><a data-toggle="tab" href="#chat" onClick="hidevideobtn()"><i class="fa fa-comment" aria-hidden="true"></i></a></li>
                                                    <li class=""><a data-toggle="tab" href="#video" onClick="initvideo()"> <i class="fa fa-video-camera" aria-hidden="true"></i></a></li>
                                                    <li class=""><a data-toggle="tab" href="#phone" onClick="phonecall()"><i class="fa fa-phone" aria-hidden="true"></i></a></li>
                                                </ul>
                                            </span> </div>
                            ...
                            <div id="chat" class="tab-pane fade in active">
                                                    ...
                                                    <div class="speech-bubble-rt">
                                                        <div class="speech-bubble-rt speech-bubble-right" id="conversation2">
                                                            ...
                                                            <?php }elseif($obj->CH_TYPE == "2"){ ?>
                                                                ...
                                                                <audio id="<?php echo $obj->CH_ID."audio"; ?>" controls="controls" style="width: 100%; height: 2.5em;">
                                                                    <source id="<?php echo $obj->CH_ID."audioSource"; ?>" src=""></source>
                                                                    Your browser does not support the audio format.
                                                                </audio>
                                                                
                                                                <script>

                                                                    var decodedStringAtoB = atob("<?php echo $obj->CH_AUDIO; ?>");
                                                            ...
                                                            <?php }elseif($obj->CH_TYPE == "3"){ ?>
                                                                <img src="https://beta.hewale.net/uploads/chatphotos/<?php echo $obj->CH_IMAGE; ?>" alt="" width="165" style="margin-bottom: 0.5em;"> <br>
                                                                <div class="formatchatdate">
                                                                    <div class="formatchatdate">
                                                                        <?php echo date("d M Y H:i", strtotime($obj->CH_DATE)); ?>
                                                                    </div>
                                                ...
                                                <?php } else { ?>
                                                    <div class="speech-bubble-lt">
                                                        <div class="speech-bubble-lt speech-bubble-left" id="conversation">
                                                            ...
                                                            <?php }elseif($obj->CH_TYPE == "3"){ ?>
                                                                <a href="https://beta.hewale.net/uploads/chatphotos/<?php echo $obj->CH_IMAGE; ?>" target="_blank">
                                                                    <img src="https://beta.hewale.net/uploads/chatphotos/<?php echo $obj->CH_IMAGE; ?>" alt="" width="165" style="margin-bottom: 0.5em;"> <br>
                                                                </a>
                                ...
                                <div class="col-sm-12 chattextarea">
                                    <textarea name="chatmsg" id="chatmsg" class="chatmsg chatmsgcount" cols="" placeholder="message..." maxlength="230"></textarea>

                                    <?php if (!empty($easyrtcid)) { ?>
                                        <button type="button" id="otherClients" class="submitchat" onClick="geteasyrtcchatid()"><i class="fa fa-send"></i></button>
                                    <?php } ?>
            ...
            "document.getElementById('viewpage').value='historylist';document.getElementById('view').value='historylist';document.myform.submit()"> Medical History</button>-->
                                    ...
                                    <div class="tab-content">
                                                ...
                                                <div class="col-sm-12 required">
                                                    ...
                                                    <div class="form-group input-group">
                                                        ...
                                                        <span class="input-group-btn">
                                                            ...
                                                            <button type="button" class="btn btn-primary" id="addcomplain" style="margin: 24px 0 0 0;">Add</button>
                                                        </span>
                                                    </div>
                                                    <div class="storydiv">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            while ($objcom = $stmtcomplain->FetchNextObject()) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td><button type='button' id='deletecomplain' onclick='deleteComplains("<?php echo $objcom->PC_CODE; ?>","Complains");' class="btn-danger removecomplain">&times;</button>
                                                                    </td>
                                                                </tr>
                                                            <?php
                                                            }
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12 required">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <select name="actiontype" id="actiontype" class="form-control select2 finalaction" tabindex="2">
                                                            ...
                                                            ?>
                                                                    <option value="<?php echo $objdetail->SERV_CODE . '_' . $objdetail->SERV_CONSULTATIONSTATUS; ?>">
                                                    ...
                                                    <div class="control-group span4 reffhos" style="margin-top:10px;">
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <select name="refferalhos" id="refferalType" class="form-control select2 finalaction1">
                                                    ...
                                                    <div class="control-group span4 reff1" style="margin-top:10px;">
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <select name="refferalType" id="refferalType" class="form-control select2 finalaction1">
                                                                <option value="" disabled selected>--- Select Action ---
                                                                </option>
                                                    ...
                                                    <div class="control-group span4 reff">
                                                        ...
                                                        <div class="controls">
                                                            <input type='text' class="form-control onlynums" name="ctnumber" id="ctnumber">
                                                        </div>
                                                    </div>

                                                    <div class="control-group span4 reffHospital" style="margin-bottom:10px;">
                                                        <label class="control-label">Hospital Name</label>
                                                        <div class="controls">

                                                            <select name="specialistphone" id="specialistphone" class="form-control select2 finalaction">
                                                                <option value="" disabled selected>--- Select a
                                                                    Specialist ---</option>
                                                                <?php
                                                                while ($objspecdetail = $referralHospitals->FetchNextObject()) {
                                                                ?>
                                                                    <option value="<?php echo $objspecdetail->REF_HOSP_TELEPHONE . ',' . $objspecdetail->REF_HOSP_CODE; ?>">
                                                    ...
                                                    <div class="control-group span4 reff2" style="margin-bottom:10px;">
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <select name="specialistphone" id="specialistphone" class="form-control select2 finalaction">
                                                                ...
                                                                ?>
                                                                    <option value="<?php echo $objspecdetail->USR_PHONENO . ',' . $objspecdetail->USR_CODE; ?>">
                                                    ...
                                                    <div class="control-group span4 reff3">
                                                        ...
                                                        <div class="controls">
                                                            <textarea name='refnote' id="refnote" maxlength="160" placeholder="Message will be sent to patient"></textarea>
                                                                ...
                                                                <div class="controls" style="margin-bottom:10px;">
                                                                    <select name="test" id="test" class="form-control select2" tabindex="2">
                                                                        ...
                                                                        <?php while ($objdpt = $stmttestlov->FetchNextObject()) {  ?>
                                                                            <option value="<?php echo $objdpt->LTT_CODE . '@@@' . $objdpt->LTT_NAME . '@@@' . $objdpt->LTT_DISCIPLINE . '@@@' . $objdpt->LTT_DISCIPLINENAME; ?>" <?php echo (($objdpt->LTT_CODE == $test) ? 'selected' : '') ?>>
                                            ...
                                            <div class="controls controls-row" style="margin-bottom:10px;">
                                                <div class="control-group span6">
                                                    ...
                                                    <div class="controls col-sm-8">
                                                        ...
                                                        <select name="dia" id="dia" class="form-control select2" tabindex="2">
                                                            ...
                                                            <?php while ($objdpt = $stmtdiagnosislov->FetchNextObject()) {  ?>
                                                                <option value="<?php echo $objdpt->DIS_CODE . '@@@' . $objdpt->DIS_NAME; ?>" <?php echo (($objdpt->DIS_CODE == $dia) ? 'selected' : '') ?>>
                                                    ...
                                                    <div class="controls col-sm-4">
                                                        ...
                                                        <select name="diatype" id="diatype" class="form-control select2" tabindex="2">
                                        ...
                                        <div id="presciption" class="tab-pane fade">
                                                    ...
                                                    <div class="controls">
                                                        <select name="drug" id="drug" class="form-control select2" tabindex="2">
                                                            ...
                                                            <?php while ($objdpt = $stmtdrugslov->FetchNextObject()) {  ?>
                                                                <option value="<?php echo $objdpt->DR_CODE . '@@@' . $objdpt->DR_NAME . '@@@' . $objdpt->DR_DOSAGE . '@@@' . $objdpt->DR_DOSAGENAME; ?>" <?php echo (($objdpt->DR_CODE == $drug) ? 'selected' : '') ?>>
                                            ...
                                            <div class="col-sm-1" style="width: 18%">
                                                <label>Dosage</label>
                                                <input type="text" class="form-control" id="frequency" name="frequency" placeholder="Dosage">
                                            </div>
                                            <div class="col-sm-1" style="width: 18%">
                                                <label>Times</label>
                                                <input type="text" class="form-control" id="times" name="times" placeholder="Times">
                                            </div>
                                            ...
                                            <div class="col-sm-2" style="width: 25%; margin-top: 5px">
                                                ...
                                                <select name="route" id="route" class="form-control">
                                                    ...
                                                    <?php while ($fetchroute = $stmtroute->FetchNextObject()) { ?>
                                                        <option value="<?php echo $fetchroute->RT_CODE . '@@@' . $fetchroute->RT_NAME ?>">
                                            ...
                                            <div class="col-sm-1 pull-right">
                                                <label id="lbl">&nbsp;</label>
                                                <button type="button" class="form-control btn btn-primary" id="addprescription" style="margin-top: -5px;">Add</button>
                                            </div>
                    ...
                    <div class="moduletitleupper" style="font-size:17px; font-weight:500;"><span class="pull-right">
            ...
            function(easyrtcid,
                ...
                easyrtc.clearMediaStream =
                    function(element) {
                        ...
                        if (typeof element.mozSrcObject !==
                            'undefined') {
...
$( window ).unload(function() {
    ...
    /*$.ajax({
			        type: 'POST',
                    dataType:'json',
					url: 'public/Doctors/consulatationpp/model/updateconsultationstatus.php',
					success: function(e){
