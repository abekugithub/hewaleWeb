<script>
    ...
    setInterval(function() {
        $.ajax({
            ...
            dataType: 'json',
            data: {
                "activeinstitution": "<?php echo $activeinstitution; ?>",
                "usrcode": "<?php echo $usrcode; ?>"
            },
            success: function(e) {
                $('tbody.tbody').html(e)
            },
    ...
    /*
     * Auto refresh the number of appointment in queue
     */
    setInterval(function() {
        $.ajax({
            type: 'POST',
            url: 'public/Doctors/consulatationpp/model/numberappointmentupdate.php',
            dataType: 'json',
            data: '',
            success: function(e) {
                $('.btnnumqueueview').html(e)
            },
        });
    }, 20000);
