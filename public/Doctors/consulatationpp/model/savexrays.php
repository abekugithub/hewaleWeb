...
if($labmain->RecordCount() == 0 ){
  ...
  $sql->Execute($sql->Prepare("INSERT INTO hms_patient_xraytest_main (XTM_ID,XTM_PACKAGECODE,XTM_VISITCODE,XTM_DATE,XTM_PATIENTNUM,XTM_PATIENTNAME,XTM_ACTORCODE,XTM_ACTORNAME,XTM_INSTCODE,XTM_PATIENTCODE,XTM_ENCRYPKEY,XTM_STATUS,XTM_TYPE,XTM_ITEMCODE,XTM_COUNTRYCODE) VALUES (".$sql->Param('1').",".$sql->Param('2').",".$sql->Param('3').",".$sql->Param('4').",".$sql->Param('5').",".$sql->Param('6').",".$sql->Param('7').",".$sql->Param('8').",".$sql->Param('9').",".$sql->Param('10').",".$sql->Param('11').",".$sql->Param('12').",".$sql->Param('13').",".$sql->Param('14').",".$sql->Param('15').")"),array($ltmmid,$prespackagecode,$visitcode,$day,$patientnum,$patientname,$usrcode,$usrname,$activeinstitution,$patientcode,$encryptkey,'1',$type,$itemcode,$countrycode));
    ...
    if ($xraycheck->RecordCount()>0){
        ...
        if (isset($activeinstitution) && !empty($activeinstitution)){
            ...
            if ($stmt->RecordCount() == 1){
                ...
                //get item code
                $stmtitcode = $sql->Execute($sql->Prepare("SELECT XTM_ITEMCODE FROM hms_patient_xraytest_main WHERE  XTM_PACKAGECODE = ".$sql->Param('a')." "),array($prespackagecode));
                $objitcode = $stmtitcode->FetchNextObject();
                $icode = $objitcode->XTM_ITEMCODE ;
             
                $stmtlab = $sql->Execute($sql->Prepare("INSERT INTO hms_patient_xraytest (XT_ID,XT_CODE,XT_VISITCODE,XT_DATE,XT_PATIENTNUM,XT_PATIENTNAME,XT_TEST,XT_TESTNAME,XT_DISCIPLINE,XT_DISCPLINENAME,XT_RMK,XT_ACTORCODE,XT_ACTORNAME,XT_INSTCODE,XT_PATIENTCODE,XT_ENCRYPKEY,XT_STATUS,XT_TYPE,XT_PACKAGECODE,XT_ITEMCODE,XT_COUNTRYCODE) VALUES (".$sql->Param('1').",".$sql->Param('2').",".$sql->Param('3').",".$sql->Param('4').",".$sql->Param('5').",".$sql->Param('6').",".$sql->Param('7').",".$sql->Param('8').",".$sql->Param('9').",".$sql->Param('10').",".$sql->Param('11').",".$sql->Param('12').",".$sql->Param('13').",".$sql->Param('13').",".$sql->Param('14').",".$sql->Param('15').",".$sql->Param('16').",".$sql->Param('17').",".$sql->Param('18').",".$sql->Param('19').",".$sql->Param('20').")"), array($ltmmid,$xcode,$visitcode,$day,$patientnum,$patientname,$xraycode,$xrayname,'','',$remark,$usrcode,$usrname,$activeinstitution,$patientcode,$encryptkey,'1',$type,$prespackagecode,$icode,$countrycode));
                ...
                $stmtlab = $sql->Execute($sql->Prepare("INSERT INTO hms_patient_xraytest (XT_ID,XT_CODE,XT_VISITCODE,XT_DATE,XT_PATIENTNUM,XT_PATIENTNAME,XT_TEST,XT_TESTNAME,XT_DISCIPLINE,XT_DISCPLINENAME,XT_RMK,XT_ACTORCODE,XT_ACTORNAME,XT_INSTCODE,XT_PATIENTCODE,XT_ENCRYPKEY,XT_TYPE,XT_PACKAGECODE,XT_STATUS,XT_ITEMCODE,XT_COUNTRYCODE) VALUES (".$sql->Param('1').",".$sql->Param('2').",".$sql->Param('3').",".$sql->Param('4').",".$sql->Param('5').",".$sql->Param('6').",".$sql->Param('7').",".$sql->Param('8').",".$sql->Param('9').",".$sql->Param('10').",".$sql->Param('11').",".$sql->Param('12').",".$sql->Param('13').",".$sql->Param('13').",".$sql->Param('14').",".$sql->Param('15').",".$sql->Param('16').",".$sql->Param('17').",".$sql->Param('18').",".$sql->Param('19').",".$sql->Param('20').")"), array($ltmmid,$xcode,$visitcode,$day,$patientnum,$patientname,$xraycode,$xrayname,'','',$remark,$usrcode,$usrname,$activeinstitution,$patientcode,$encryptkey,$type,$prespackagecode,'1',$icode,$countrycode));
