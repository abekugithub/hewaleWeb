 ...
 */
  ...
  if($labmain->RecordCount() == 0 ){
    $ltmmid = uniqid();
    $sql->Execute($sql->Prepare("INSERT INTO hms_patient_labtest_main(LTM_ID,LTM_PACKAGECODE,LTM_VISITCODE,LTM_DATE,LTM_PATIENTNUM,LTM_PATIENTNAME,LTM_RMK,LTM_ACTORCODE,LTM_ACTORNAME,LTM_INSTCODE,LTM_PATIENTCODE,LTM_LABCODE,LTM_LABNAME,LTM_ITEMCODE) VALUES (".$sql->Param('1').",".$sql->Param('2').",".$sql->Param('3').",".$sql->Param('4').",".$sql->Param('5').",".$sql->Param('6').",".$sql->Param('7').",".$sql->Param('8').",".$sql->Param('9').",".$sql->Param('10').",".$sql->Param('11').",".$sql->Param('12').",".$sql->Param('13').",".$sql->Param('14').")"),
    array($ltmmid,$prespackagecode,$visitcode,$day,$patientnum,$patientname,$remark,$usrcode,$usrname,$activeinstitution,$patientcode,'','',$itemcode));
    print $sql->ErrorMsg();
}
    ...
    if ($labscheck->RecordCount()>0){
        ...
        if (isset($activeinstitution) && !empty($activeinstitution)){
            ...
            if ($stmt->RecordCount() == 1){
                ...
                $stmtlab = $sql->Execute($sql->Prepare("INSERT INTO hms_patient_labtest (LT_CODE,LT_VISITCODE,LT_DATE,LT_PATIENTNUM,LT_PATIENTNAME,LT_TEST,LT_TESTNAME,LT_DISCIPLINE,LT_DISCPLINENAME,LT_RMK,LT_ACTORCODE,LT_ACTORNAME,LT_INSTCODE,LT_PATIENTCODE,LT_ENCRYPKEY,LT_LABCODE,LT_LABNAME,LT_STATUS,LT_ID,LT_PACKAGECODE,LT_ITEMCODE) VALUES (".$sql->Param('1').",".$sql->Param('2').",".$sql->Param('3').",".$sql->Param('4').",".$sql->Param('5').",".$sql->Param('6').",".$sql->Param('7').",".$sql->Param('8').",".$sql->Param('9').",".$sql->Param('10').",".$sql->Param('11').",".$sql->Param('12').",".$sql->Param('13').",".$sql->Param('13').",".$sql->Param('14').",".$sql->Param('15').",".$sql->Param('16').",".$sql->Param('17').",".$sql->Param('18').",".$sql->Param('19').",".$sql->Param('20').",".$sql->Param('21').")"),
                    array($lqcode,$visitcode,$day,$patientnum,$patientname,$testcode,$testname,$dicscode,$dicsname,$remark,$usrcode,$usrname,$activeinstitution,$patientcode,$encryptkey,$activeinstitution,$activeinstitution,'6',$lttid,$prespackagecode,$icode));
			...
			$tablerowid= $client->REQU_ID;
                ...
                $stmtlab = $sql->Execute($sql->Prepare("INSERT INTO hms_patient_labtest (LT_CODE,LT_VISITCODE,LT_DATE,LT_PATIENTNUM,LT_PATIENTNAME,LT_TEST,LT_TESTNAME,LT_DISCIPLINE,LT_DISCPLINENAME,LT_RMK,LT_ACTORCODE,LT_ACTORNAME,LT_INSTCODE,LT_PATIENTCODE,LT_ENCRYPKEY,LT_ID,LT_PACKAGECODE,LT_ITEMCODE) VALUES (".$sql->Param('1').",".$sql->Param('2').",".$sql->Param('3').",".$sql->Param('4').",".$sql->Param('5').",".$sql->Param('6').",".$sql->Param('7').",".$sql->Param('8').",".$sql->Param('9').",".$sql->Param('10').",".$sql->Param('11').",".$sql->Param('12').",".$sql->Param('13').",".$sql->Param('13').",".$sql->Param('14').",".$sql->Param('15').",".$sql->Param('16').",".$sql->Param('17').")"),
                    array($lqcode,$visitcode,$day,$patientnum,$patientname,$testcode,$testname,$dicscode,$dicsname,$remark,$usrcode,$usrname,$activeinstitution,$patientcode,$encryptkey,$lttid,$prespackagecode,$icode));
