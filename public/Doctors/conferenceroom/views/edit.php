    ...
    <div class="page-wrapper">
        <div class="page form">
            <div class="moduletitle">
                <div class="moduletitleupper">Edit Conference Details<span class="pull-right">
                ...
                <button type="button" class="btn btn-success" onclick="document.getElementById('view').value='';document.getElementById('viewpage').value='updatecon';document.myform.submit();">Next</button>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                             ...
                             <div class="col-sm-4">
                                ...
                                <input type="text" class="form-control" id="confname" name="confname1" value=" <?php echo $confname ;?>" autocomplete="off">
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" class="form-control" id="starttime" name="starttime1" value="<?php echo $starttime ;?>" autocomplete="off">
                            </div>
