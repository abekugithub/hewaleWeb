...
<div class="page-chat page-content bg-page">
    ...
    <div class="content-block">
        ...
        <div id="video" class="tab-pane fade in">
            ...
            <video id="box5" class="transit boxCommon thumbCommon" style="visibility:hidden" autoplay="autoplay" playsinline="playsinline"></video>
            <video id="box6" class="transit boxCommon thumbCommon" style="visibility:hidden" autoplay="autoplay" playsinline="playsinline"></video>
            <video id="box7" class="transit boxCommon thumbCommon" style="visibility:hidden" autoplay="autoplay" playsinline="playsinline"></video>
            <video id="box8" class="transit boxCommon thumbCommon" style="visibility:hidden" autoplay="autoplay" playsinline="playsinline"></video>
            <video id="box9" class="transit boxCommon thumbCommon" style="visibility:hidden" autoplay="autoplay" playsinline="playsinline"></video>
            <video id="box10" class="transit boxCommon thumbCommon" style="visibility:hidden" autoplay="autoplay" playsinline="playsinline"></video>
...
<script type="text/javascript">
    ...
    //easyrtc.easyApp("easyrtc.multiparty", "box0", ["box1", "box2", "box3"], loginSuccess);
    easyrtc.easyApp("<?php echo $roomname ;?>", "box0", ["box1", "box2", "box3", "box4", "box5", "box6", "box7", "box8", "box9", "box10"], loginSuccess);
...
function reshape1of9(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3,
        top: (parenth - sharedVideoHeight*2)/3,
        width: sharedVideoWidth,
...
function reshape2of9(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3*2+ sharedVideoWidth,
        top: (parenth - sharedVideoHeight*2)/3,
        width: sharedVideoWidth,
...
function reshape3of9(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3,
        top: (parenth - sharedVideoHeight*2)/3*2 + sharedVideoHeight,
        width: sharedVideoWidth,
...
function reshape4of9(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3*2 + sharedVideoWidth,
        top: (parenth - sharedVideoHeight*2)/3*2 + sharedVideoHeight,
        width: sharedVideoWidth,
...
function reshape5of9(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3*2 + sharedVideoWidth,
        top: (parenth - sharedVideoHeight*2)/3*2 + sharedVideoHeight,
        width: sharedVideoWidth,
...
function reshape6of9(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3*2 + sharedVideoWidth,
        top: (parenth - sharedVideoHeight*2)/3*2 + sharedVideoHeight,
        width: sharedVideoWidth,
...
function reshape7of9(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3*2 + sharedVideoWidth,
        top: (parenth - sharedVideoHeight*2)/3*2 + sharedVideoHeight,
        width: sharedVideoWidth,
...
function reshape8of9(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3*2 + sharedVideoWidth,
        top: (parenth - sharedVideoHeight*2)/3*2 + sharedVideoHeight,
        width: sharedVideoWidth,
...
function reshape9of9(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3*2 + sharedVideoWidth,
        top: (parenth - sharedVideoHeight*2)/3*2 + sharedVideoHeight,
        width: sharedVideoWidth,
...
function reshape1of10(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3,
        top: (parenth - sharedVideoHeight*2)/3,
        width: sharedVideoWidth,
...
function reshape2of10(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3*2+ sharedVideoWidth,
        top: (parenth - sharedVideoHeight*2)/3,
        width: sharedVideoWidth,
...
function reshape3of10(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3,
        top: (parenth - sharedVideoHeight*2)/3*2 + sharedVideoHeight,
        width: sharedVideoWidth,
...
function reshape4of10(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3*2 + sharedVideoWidth,
        top: (parenth - sharedVideoHeight*2)/3*2 + sharedVideoHeight,
        width: sharedVideoWidth,
...
function reshape5of10(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3*2 + sharedVideoWidth,
        top: (parenth - sharedVideoHeight*2)/3*2 + sharedVideoHeight,
        width: sharedVideoWidth,
...
function reshape6of10(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3*2 + sharedVideoWidth,
        top: (parenth - sharedVideoHeight*2)/3*2 + sharedVideoHeight,
        width: sharedVideoWidth,
...
function reshape7of10(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3*2 + sharedVideoWidth,
        top: (parenth - sharedVideoHeight*2)/3*2 + sharedVideoHeight,
        width: sharedVideoWidth,
...
function reshape8of10(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3*2 + sharedVideoWidth,
        top: (parenth - sharedVideoHeight*2)/3*2 + sharedVideoHeight,
        width: sharedVideoWidth,
...
function reshape9of10(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3*2 + sharedVideoWidth,
        top: (parenth - sharedVideoHeight*2)/3*2 + sharedVideoHeight,
        width: sharedVideoWidth,
...
function reshape10of10(parentw, parenth) {
    return {
        left: (parentw - sharedVideoWidth*2)/3*2 + sharedVideoWidth,
        top: (parenth - sharedVideoHeight*2)/3*2 + sharedVideoHeight,
        width: sharedVideoWidth,
...
var boxUsed = [true, false, false, false,false,false,false,false,false,false];
var connectCount = 0;
    ...
    function(parentw, parenth) {
        ...
        if( activeBox > 0 ) {
            ...
            switch(connectCount) {
                ...
                case 8:return reshape1of9(parentw, parenth);
                case 9:return reshape1of10(parentw, parenth);
            }
        }
    },
    function(parentw, parenth) {
        if( activeBox >= 0 || !boxUsed[1]) {
            ...
            switch(connectCount) {
                ...
                case 8:
                    return reshape2of9(parentw, parenth);
                case 9:
                    return reshape2of10(parentw, parenth);
            }
        }
    },
    function(parentw, parenth) {
        if( activeBox >= 0 || !boxUsed[2] ) {
            ...
            switch(connectCount){
                ...
                case 8:
                    return reshape3of9(parentw, parenth);
                case 9:
                    return reshape3of10(parentw, parenth);
            }
        }
    },
    function(parentw, parenth) {
        if( activeBox >= 0 || !boxUsed[3]) {
            ...
            switch(connectCount){
                case 1:
                    return reshape4of2(parentw, parenth);
                case 2:
                    return reshape4of3(parentw, parenth);
                case 3:
                ...
                case 8:
                    return reshape4of9(parentw, parenth);
                case 9:
                    return reshape4of10(parentw, parenth);
            }
        }
    },
    function(parentw, parenth) {
        if( activeBox >= 0 || !boxUsed[4]) {
            ...
            switch(connectCount){
                case 1:
                    return reshape5of2(parentw, parenth);
                case 2:
                    return reshape5of3(parentw, parenth);
                case 3:
                    return reshape5of4(parentw, parenth);
                case 4:
                ...
                case 8:
                    return reshape5of9(parentw, parenth);
                case 9:
                    return reshape5of10(parentw, parenth);
            }
        }
    },
    function(parentw, parenth) {
        if( activeBox >= 0 || !boxUsed[5]) {
            ...
            switch(connectCount){
                case 1:
                    return reshape6of2(parentw, parenth);
                case 2:
                    return reshape6of3(parentw, parenth);
                case 3:
                    return reshape6of4(parentw, parenth);
                case 4:
                    return reshape6of5(parentw, parenth);
                case 5:
                ...
                case 8:
                    return reshape6of9(parentw, parenth);
                case 9:
                    return reshape6of10(parentw, parenth);
            }
        }
    },
    function(parentw, parenth) {
        if( activeBox >= 0 || !boxUsed[6]) {
            ...
            switch(connectCount){
                case 1:
                    return reshape7of2(parentw, parenth);
                case 2:
                    return reshape7of3(parentw, parenth);
                case 3:
                    return reshape7of4(parentw, parenth);
                case 4:
                    return reshape7of5(parentw, parenth);
                case 5:
                    return reshape7of6(parentw, parenth);
                case 6:
                    return reshape7of7(parentw, parenth);
                case 7:
                    return reshape7of8(parentw, parenth);
                case 8:
                    return reshape7of9(parentw, parenth);
                case 9:
                    return reshape7of10(parentw, parenth);
            }
        }
    },
    function(parentw, parenth) {
        if( activeBox >= 0 || !boxUsed[7]) {
            ...
            switch(connectCount){
                case 1:
                    return reshape8of2(parentw, parenth);
                case 2:
                    return reshape8of3(parentw, parenth);
                case 3:
                    return reshape8of4(parentw, parenth);
                case 4:
                    return reshape8of5(parentw, parenth);
                case 5:
                    return reshape8of6(parentw, parenth);
                case 6:
                    return reshape8of7(parentw, parenth);
                case 7:
                    return reshape8of8(parentw, parenth);
                case 8:
                    return reshape8of9(parentw, parenth);
                case 9:
                    return reshape8of10(parentw, parenth);
            }
        }
    },
    function(parentw, parenth) {
        if( activeBox >= 0 || !boxUsed[8]) {
            return setThumbSize(0.20, -0.01, -0.01, parentw, parenth);
        }
        else{
            switch(connectCount){
                case 1:
                    return reshape9of2(parentw, parenth);
                case 2:
                    return reshape9of3(parentw, parenth);
                case 3:
                    return reshape9of4(parentw, parenth);
                case 4:
                    return reshape9of5(parentw, parenth);
                case 5:
                    return reshape9of6(parentw, parenth);
                case 6:
                    return reshape9of7(parentw, parenth);
                case 7:
                    return reshape9of8(parentw, parenth);
                case 8:
                    return reshape9of9(parentw, parenth);
                case 9:
                    return reshape9of10(parentw, parenth);
            }
        }
    },
    function(parentw, parenth) {
        if( activeBox >= 0 || !boxUsed[9]) {
            ...
            switch(connectCount){
                ...
                case 8:
                    return reshape9of9(parentw, parenth);
                case 9:
                    return reshape10of10(parentw, parenth);
            }
        }
    }
