        ...
        <div class="page-wrapper">
            ...
            <div class="page form">
                <div class="moduletitle" style="margin-bottom:0px;">
                    <div class="moduletitleupper">Pending Prescriptions</div> 
                </div>
<?php $engine->msgBox($msg,$status); ?>
                ...
                <table class="table table-hover">
                 ...
                 $num = 1;
                  if($paging->total_rows > 0 ){
                           ...
                           if($obj->PRESC_DEL_STATUS == 1){
                            $delmeth = 'Courrier Pickup';
                   ...
                   echo '<tr >
						...
						<button type="submit" class="btn btn-info btn-square" onclick="document.getElementById(\'view\').value=\'prescdetails\';document.getElementById(\'keys\').value=\''.$obj->PRESC_VISITCODE.'\';document.getElementById(\'viewpage\').value=\'prescrdetails\';document.myform.submit;">Details</button>
