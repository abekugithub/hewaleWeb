        ...
        <div class="page-wrapper">
            ...
            <div class="page form">
                <div class="moduletitle" style="margin-bottom:0px;">
                    <div class="moduletitleupper">Stock Management</div>
                </div>
                ...
                <div class="pagination-tab">
                    <div class="table-title">
                        ...
                        <div class="pagination-right">
                            <button type="button" data-toggle="modal" data-target="#addStock" class="btn btn-info"><i class="fa fa-plus-circle"></i> Restock Stock </button>
                            <button type="button" data-toggle="modal" data-target="#suppliers" class="btn btn-success"><i class="fa fa-truck"></i> Suppliers </button>
                        </div>
                    </div>
                </div>
...
<!-- Modal -->
<div id="addStock" class="modal fade mymodal" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Restock Stocks</h4>
            </div>
...
<!-- Modal for Suppliers -->
<div id="suppliers" class="modal fade mymodal" role="dialog">
    <div class="modal-dialog">
    ...
    $(document).ready(function () {
        ...
        $(".modalMinimize").on("click", function () {
            ...
            if ($($modal).hasClass("min")) {
                $(".minimized-modal").append($apnData);
