    ...
    <div class="page-wrapper">
        <div class="page form">
            <div class="moduletitle">
                <div class="moduletitleupper">Filter - Cash Flow Report
...
<!--                    <div class="col-sm-12">-->
<!--                        <div class="col-sm-5">-->
<!--                            <label for="prescriber">Cash Flow Option:</label>-->
<!--                            <select id="prescriber_name" name="prescriber_name" class="form-control select2" tabindex="-1" aria-hidden="true">-->
<!--                                <option value="" selected disabled>Select Option</option>-->
<!--                                <option value="1">Credits</option>-->
<!--                                <option value="2">Debits</option>-->
<!--                            </select>-->
<!---->
<!--                        </div>-->
<!--                        <div class="col-sm-5">-->
<!--                            <label for="hewale_number">Hewale Number:</label>-->
<!--                            <input type="text" placeholder="Enter hewale number" class="form-control" id="hewale_number" name="hewale_number">-->
<!--                        </div>-->
<!--                    </div>-->
                </div>
