...
if(is_array($dashmenu)){
    $output = '<div class="row-fluid"><div class="col-sm-9">';
        ...
        $output .=' <div class="col-sm-3">
                      ...
                      $output .='<div '.(($facicode == $objchp->CDA_HOSPITAL_FACCODE)?'style="background-color:#ffdd44"':'' ).' class="card-body wrapper" onclick="document.getElementById(\'facicode\').value=\''.$objchp->CDA_HOSPITAL_FACCODE.'\';document.getElementById(\'viewpage\').value=\'changeVH\';document.myform.submit();">
