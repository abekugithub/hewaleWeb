...
<div class="main-content">
    <form action="" method="post" enctype="multipart/form-data" name="myform">
        ...
        <input type="hidden" class="form-control" id="unkpatientnum" name="unkpatientnum" value="<?php echo $unkpatientnum; ?>">
                    ...
                    <div class=" col-sm-12">
                        <div class="moduletitle" style="margin-bottom:0px;">
                            <div class="moduletitleupper">Vitals
                                ...
                                <button type="button" class="btn btn-success" onclick="saveJaneDoe();"><i class="fa fa-check"></i> Save</button>
                                </span>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="col-sm-12 client-vitals-opt">
                                                <div class="col-sm-4 required">
                                                    ...
                                                    <select class="form-control" name="vitals_type" id="vitals_type">
                                                        ...
                                                        <?php while($obj1 = $stmtoptions->FetchNextObject()){ ?>
