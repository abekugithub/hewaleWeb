...
<div class="main-content">
    <div class="page-wrapper">
        <div class="page form">
            <div class="moduletitle" style="margin-bottom:0px;">
                <div class="moduletitleupper">New Emergency </div>
            </div>
   ...
   <!--                       <button type="submit" class="btn btn-success" onclick="document.getElementById('views').value='add';document.myform.submit();"><i class="fa fa-user-plus"></i> View all</button>
         ...
         -->           
                        ...
                        <button type="submit" class="btn btn-primary" style="position: relative;right: -200px;"onclick="document.getElementById('views').value='add_janedoe';document.myform.submit();"><i class="fa fa-drivers-license-o"></i> Jane Doe </button>
                    </div>
...
<!--                    <th></th>-->
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $sql->userDate($obj->EMER_INPUTDATE,'d/m/Y'); ?></td>
                        <td>
                        <input type="hidden" id="patientnum" name="patientnum" value="<?php echo $obj->PATIENT_PATIENTNUM; ?>" >
                          <input type="hidden" name="v" value="<?php echo $obj->EMER_CODE;?>" id="v" class="form-control" />
                              <button type="submit" class="btn btn-primary" onclick="document.getElementById('keys').value='<?php echo $obj->EMER_VISITCODE;?>';document.getElementById('views').value='add';document.getElementById('patkey').value='<?php echo $obj->PATIENT_PATIENTCODE;?>';document.getElementById('viewpage').value='manage';"><i class="fa fa-briefcase"></i> Manage</button>
                        </td>
                    </tr>
                <?php $num++; }
                }
