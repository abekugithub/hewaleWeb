...
<!--                        <input class="form-control" id="groupname" name="groupname" placeholder="Enter Group Name" type="text" required/>-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <button type="button" id="newgroup" class="btn btn-success btn-square" data-dismiss="modal" onclick="document.getElementById('v').value='add';/*document.myform.submit();/*document.getElementById('viewpages').value='add';*/document.myform.submit();">Save</button>
