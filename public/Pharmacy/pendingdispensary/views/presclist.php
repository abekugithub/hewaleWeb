                            ...
                            <table class="table table-hover">
                                ...
                                if (!empty($cartprepare) && count($cartprepare)>0){
                                    ...
                                    foreach ($cartprepare as $key){
                                        $grandtotal = $grandtotal + (intval($key['QUANTITY']) * floatval($key['COST']));
                                        ?>
...
<!--                                                <br><div class="form-label required"><strike>--><?php //echo $key['PRESC_FREQ'] .' * '.$key['PRESC_DAYS']?><!--</strike></div>-->
                                            ...
                                            <td>
                                                <label class="form-label required"><?php echo $key['PRESC_FREQ']?></label>
                                            ...
                                            <td>
                                                <input onkeyup="doSum('quantity<?php echo $i;?>','cost<?php echo $i;?>','total<?php echo $i;?>')" type="text" class="form-control" id="cost<?php echo $i;?>" name="cost[<?php echo $i;?>]" value="<?php echo !empty($key['COST'])?number_format($key['COST'],2):0?>" />
                                            </td>
                                            <td>
                                                <input onkeyup="doSum('quantity<?php echo $i;?>','cost<?php echo $i;?>','total<?php echo $i;?>')" type="text" class="form-control" id="quantity<?php echo $i;?>" name="quantity[<?php echo $i;?>]" value="<?php echo $key['QUANTITY']?>" />
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" id="total<?php echo $i;?>" value="<?php echo number_format(intval($key['QUANTITY']) * floatval($key['COST']),2)?>" name="total" />
                                                <?php
