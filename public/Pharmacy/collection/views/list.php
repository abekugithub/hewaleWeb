        ...
        <div class="col-md-12">
                ...
                <div class="page form">
                    <div class="moduletitle" style="margin-bottom:0px;">
                        <div class="moduletitleupper">Manage Collection</div>
                    ...
                    <table class="table table-hover">
				       ...
				       <td>'.$num++.'</td>
						...
						<td><button type="submit" class="btn btn-success btn-square" onclick="document.getElementById(\'view\').value=\'sales\';document.getElementById(\'hewale_number\').value=\''.$obj->PRESCM_PATIENTNUM.'\';document.getElementById(\'keys\').value=\''.$obj->PRESCM_PACKAGECODE.'\';document.getElementById(\'viewpage\').value=\'sales\';document.myform.submit;">View Detail</button></td>
